import {
  markdown
} from "./chunk-AHJIIJDU.js";
import "./chunk-HVY2S3ZD.js";
import "./chunk-C4ET3LYF.js";
import "./chunk-VYV5CXAY.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-VDLFXTMN.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
  ...
  syntaxTree,
  tags
} from "./chunk-YYCY3YJP.js";
import "./chunk-ULFHBZFY.js";
import {
  Fragment,
  cloneVNode,
  ...
  "node_modules/mdurl/decode.js"(exports, module) {
    ...
    function decode2(string, exclude) {
      ...
      return string.replace(/(%[a-f0-9]{2})+/gi, function(seq) {
        var i2, l2, b1, b22, b32, b4, chr, result = "";
        for (i2 = 0, l2 = seq.length; i2 < l2; i2 += 3) {
          ...
          if ((b1 & 224) === 192 && i2 + 3 < l2) {
            b22 = parseInt(seq.slice(i2 + 4, i2 + 6), 16);
            if ((b22 & 192) === 128) {
          ...
          if ((b1 & 240) === 224 && i2 + 6 < l2) {
            b22 = parseInt(seq.slice(i2 + 4, i2 + 6), 16);
            b32 = parseInt(seq.slice(i2 + 7, i2 + 9), 16);
...
var require_linkify = __commonJS({
  "node_modules/markdown-it/lib/rules_core/linkify.js"(exports, module) {
    ...
    module.exports = function linkify(state) {
      var i2, j2, l2, tokens, token, currentToken, nodes, ln, text, pos, lastPos, level, htmlLinkLevel, url, fullUrl, urlText, blockTokens = state.tokens, links;
...
var require_linkify_it = __commonJS({
  "node_modules/linkify-it/index.js"(exports, module) {
    ...
    LinkifyIt.prototype.test = function test(text) {
      ...
      var m4, ml2, me, len, shift, next, re2, tld_pos, at_pos;
      if (this.re.schema_test.test(text)) {
        re2 = this.re.schema_search;
        re2.lastIndex = 0;
        while ((m4 = re2.exec(text)) !== null) {
          len = this.testSchemaAt(text, m4[2], re2.lastIndex);
          if (len) {
      ...
      if (this.__opts__.fuzzyLink && this.__compiled__["http:"]) {
        ...
        if (tld_pos >= 0) {
          if (this.__index__ < 0 || tld_pos < this.__index__) {
            if ((ml2 = text.match(this.__opts__.fuzzyIP ? this.re.link_fuzzy : this.re.link_no_ip_fuzzy)) !== null) {
    ...
    LinkifyIt.prototype.matchAtStart = function matchAtStart(text) {
      ...
      if (!text.length)
        return null;
      var m4 = this.re.schema_at_start.exec(text);
      if (!m4)
        return null;
      var len = this.testSchemaAt(text, m4[2], m4[0].length);
      if (!len)
        return null;
      this.__schema__ = m4[2];
      this.__index__ = m4.index + m4[1].length;
  ...
  "node_modules/punycode/punycode.es6.js"() {
    ...
    encode = function(input) {
      ...
      while (handledCPCount < inputLength) {
        let m4 = maxInt;
        for (const currentValue of input) {
          if (currentValue >= n3 && currentValue < m4) {
            m4 = currentValue;
          }
        }
        const handledCPCountPlusOne = handledCPCount + 1;
        if (m4 - n3 > floor((maxInt - delta) / handledCPCountPlusOne)) {
          error("overflow");
        }
        delta += (m4 - n3) * handledCPCountPlusOne;
        n3 = m4;
        for (const currentValue of input) {
...
var I = defineComponent({
  props: B,
  setup(e4, a3) {
    const i2 = `${a}-dropdown-hidden`, t2 = reactive({
      overlayClass: [i2],
      overlayStyle: {},
      triggerHover: false,
      overlayHover: false
      ...
      if (!o2 || !l2)
        return;
      const v = o2.getBoundingClientRect(), u3 = o2.offsetTop, L4 = o2.offsetLeft, S2 = v.height, b4 = v.width, w = ((p3 = document.querySelector(e4.relative)) == null ? void 0 : p3.scrollLeft) || 0;
      t2.overlayStyle = {
        ...t2.overlayStyle,
        top: u3 + S2 + "px",
        left: L4 - l2.offsetWidth / 2 + b4 / 2 - w + "px"
      }, e4.onChange(true);
    }, m4 = () => {
      t2.overlayHover = true;
    };
    watch(() => e4.visible, (o2) => {
      o2 ? t2.overlayClass = t2.overlayClass.filter((l2) => l2 !== i2) : t2.overlayClass.push(i2);
    });
    let h3 = -1;
    const s2 = (o2) => {
      r3.value === o2.target ? t2.triggerHover = false : t2.overlayHover = false, clearTimeout(h3), h3 = window.setTimeout(() => {
        !t2.overlayHover && !t2.triggerHover && e4.onChange(false);
      }, 10);
    };
    return onMounted(() => {
      r3.value.addEventListener("mouseenter", y), r3.value.addEventListener("mouseleave", s2), n3.value.addEventListener("mouseenter", m4), n3.value.addEventListener("mouseleave", s2);
    }), onBeforeUnmount(() => {
      r3.value.removeEventListener("mouseenter", y), r3.value.removeEventListener("mouseleave", s2), n3.value.removeEventListener("mouseenter", m4), n3.value.removeEventListener("mouseleave", s2);
    }), () => {
      const o2 = s({
        ctx: a3
      }), l2 = s({
        props: e4,
        ctx: a3
      }, "overlay"), v = cloneVNode(o2 instanceof Array ? o2[0] : o2, {
        ref: r3
      }), u3 = createVNode("div", {
  ...
  setup(e4, a3) {
    ...
    return () => {
      ...
      return createVNode(I, {
        relative: `#${i2}-toolbar-wrapper`,
        visible: e4.visible,
        onChange: (n3) => {
          e4.onChange instanceof Function ? e4.onChange(n3) : a3.emit("onChange", n3);
        },
        overlay: r3
      }, {
...
f.install = (e4) => (e4.component(f.name, f), e4);
...
var u2 = class {
  ...
  // 移除事件监听
  remove(t2, s2, n3) {
    const i2 = this.pools[t2] && this.pools[t2][s2];
    i2 && (this.pools[t2][s2] = i2.filter((r3) => r3 !== n3));
  }
...
var g2 = new u2();
var f2 = (o2, t2 = "image.png") => {
  const s2 = o2.split(","), n3 = s2[0].match(/:(.*?);/);
  if (n3) {
    const e4 = n3[1], i2 = atob(s2[1]);
    let r3 = i2.length;
    const l2 = new Uint8Array(r3);
    for (; r3--; )
      l2[r3] = i2.charCodeAt(r3);
...
var L2 = (e4, d2) => {
  const t2 = (n3) => {
    const o2 = e4.parentElement || document.body, i2 = o2.offsetWidth, m4 = o2.offsetHeight, { clientWidth: u3 } = document.documentElement, { clientHeight: l2 } = document.documentElement, p3 = n3.offsetX, v = n3.offsetY, a3 = (f3) => {
      let s2 = f3.x + document.body.scrollLeft - document.body.clientLeft - p3, c3 = f3.y + document.body.scrollTop - document.body.clientTop - v;
      s2 = s2 < 1 ? 1 : s2 < u3 - i2 - 1 ? s2 : u3 - i2 - 1, c3 = c3 < 1 ? 1 : c3 < l2 - m4 - 1 ? c3 : l2 - m4 - 1, d2 ? d2(s2, c3) : (o2.style.left = `${s2}px`, o2.style.top = `${c3}px`);
    };
...
var h2 = (e4, d2 = "") => {
  ...
  const o2 = function(i2) {
    typeof n3 == "function" && n3.bind(this)(i2), e4.removeEventListener("load", o2);
  };
...
function i(e4, i2) {
  ...
  if ("alt" === e4)
    return i2.content;
  const r3 = i2.attrs.find(([t2]) => "title" === t2);
  return Array.isArray(r3) && r3[1] ? (n2(i2, "title"), r3[1]) : void 0;
}
function r2(t2, r3) {
  r3 = r3 || {}, t2.core.ruler.before("linkify", "image_figures", function(s2) {
    ...
    for (let o2 = 1, c3 = s2.tokens.length; o2 < c3 - 1; ++o2) {
      ...
      let h3;
      if (f3.type = "figure_open", f3.tag = "figure", s2.tokens[o2 + 1].type = "figure_close", s2.tokens[o2 + 1].tag = "figure", r3.dataType && s2.tokens[o2 - 1].attrPush(["data-type", "image"]), r3.link && 1 === l2.children.length) {
        [h3] = l2.children;
        const t3 = new s2.Token("link_open", "a", 1);
        t3.attrPush(["href", h3.attrGet("src")]), l2.children.unshift(t3), l2.children.push(new s2.Token("link_close", "a", -1));
      }
      if (h3 = 1 === l2.children.length ? l2.children[0] : l2.children[1], r3.figcaption) {
        const n3 = i(r3.figcaption, h3);
        if (n3) {
          const [i2] = t2.parseInline(n3, s2.env);
          l2.children.push(new s2.Token("figcaption_open", "figcaption", 1)), l2.children.push(...i2.children), l2.children.push(new s2.Token("figcaption_close", "figcaption", -1)), h3.attrs && (h3.attrs = e2(h3.attrs, "title"));
        }
      }
      if (r3.copyAttrs && h3.attrs) {
        const t3 = true === r3.copyAttrs ? "" : r3.copyAttrs;
        f3.attrs = h3.attrs.filter(([e4]) => e4.match(t3)).map((t4) => Array.from(t4));
      }
      if (r3.tabindex && (s2.tokens[o2 - 1].attrPush(["tabindex", a3]), a3++), r3.lazy && (h3.attrs.some(([t3]) => "loading" === t3) || h3.attrs.push(["loading", "lazy"])), r3.async && (h3.attrs.some(([t3]) => "decoding" === t3) || h3.attrs.push(["decoding", "async"])), r3.classes && "string" == typeof r3.classes) {
        let t3 = false;
        for (let e4 = 0, n3 = h3.attrs.length; e4 < n3 && !t3; e4++) {
          const n4 = h3.attrs[e4];
          "class" === n4[0] && (n4[1] = `${n4[1]} ${r3.classes}`, t3 = true);
        }
        t3 || h3.attrs.push(["class", r3.classes]);
      }
      if (r3.removeSrc) {
        const t3 = h3.attrs.find(([t4]) => "src" === t4);
        h3.attrs.push(["data-src", t3[1]]), n2(h3, "src");
      }
    }
  });
}
  ...
  static unsafeExposeInternals(c3) {
    return {
      ...
      backgroundFetch: (k2, index, options, context) => {
        var _a;
        return __privateMethod(_a = c3, _backgroundFetch, backgroundFetch_fn).call(_a, k2, index, options, context);
      },
      moveToTail: (index) => {
        var _a;
  ...
  *rvalues() {
  ...
  async fetch(k2, fetchOptions = {}) {
    ...
    if (index === void 0) {
      if (status)
        status.fetch = "miss";
      const p3 = __privateMethod(this, _backgroundFetch, backgroundFetch_fn).call(this, k2, index, options, context);
...
// node_modules/md-editor-v3/lib/es/chunks/index.mjs
var Q = "onSave";
var Y = "changeCatalogVisible";
var Ce = "changeFullscreen";
var V = "pageFullscreenChanged";
var G = "fullscreenChanged";
var D = "previewChanged";
var z = "htmlPreviewChanged";
var K = "catalogVisibleChanged";
var Se = "textareaFocus";
var Ie = (e4, o2) => {
  const a3 = inject("editorId"), n3 = x(() => {
    const t2 = document.querySelectorAll(`#${a3}-preview img`);
    t2.length !== 0 && medium_zoom_esm_default(t2, {
      background: "#00000073"
    });
  });
  onMounted(n3), watch([o2, toRef(e4.setting, "preview")], n3);
};
var Pe = Ie;
var Te = (e4, o2) => {
  const a3 = inject("editorId"), n3 = inject("usedLanguageText"), t2 = () => {
    document.querySelectorAll(`#${a3}-preview pre`).forEach((c3) => {
      var m4, f3;
      let d2 = -1;
      (m4 = c3.querySelector(".copy-button")) == null || m4.remove();
      const s2 = ((f3 = n3.value.copyCode) == null ? void 0 : f3.text) || "复制代码", r3 = document.createElement("span");
      r3.setAttribute("class", "copy-button"), r3.dataset.tips = s2, r3.innerHTML = `<svg class="${a}-icon" aria-hidden="true"><use xlink:href="#${a}-icon-copy"></use></svg>`, r3.addEventListener("click", () => {
        var w, v;
        clearTimeout(d2);
        const b4 = c3.querySelector("code").innerText, u3 = (0, import_copy_to_clipboard.default)(e4.formatCopiedText(b4)), g4 = ((w = n3.value.copyCode) == null ? void 0 : w.successTips) || "已复制！", h3 = ((v = n3.value.copyCode) == null ? void 0 : v.failTips) || "已复制！";
        r3.dataset.tips = u3 ? g4 : h3, d2 = window.setTimeout(() => {
          r3.dataset.tips = s2;
        }, 1500);
      }), c3.appendChild(r3);
    });
  ...
  watch(() => o2.value, l2), watch(() => e4.setting.preview, i2), watch(() => e4.setting.htmlPreview, i2), watch(() => n3.value, t2), onMounted(t2);
};
var Ee = Te;
var _e = (e4) => {
  var l2;
  const o2 = (l2 = l.editorExtensions) == null ? void 0 : l2.highlight, a3 = o2 == null ? void 0 : o2.instance, n3 = inject("highlight"), t2 = shallowRef(a3);
  return onMounted(() => {
    if (!e4.noHighlight && !t2.value) {
      const i2 = document.createElement("script");
      i2.src = n3.value.js, i2.onload = () => {
        t2.value = window.hljs;
      }, i2.id = `${a}-hljs`, h2(i2, "hljs");
      const c3 = document.createElement("link");
      c3.rel = "stylesheet", c3.href = n3.value.css, c3.id = `${a}-hlCss`, h2(c3);
    }
  }), watch(
    () => n3.value.css,
    (i2) => {
...
var Fe = _e;
var He = (e4) => {
  const o2 = inject("theme"), { editorExtensions: a3 } = l, n3 = a3 == null ? void 0 : a3.mermaid, t2 = shallowRef(n3 == null ? void 0 : n3.instance), l2 = shallowRef(-1), i2 = new mjs_default({
    max: 1e3,
    // 缓存10分钟
    ttl: 6e5
  }), c3 = () => {
    ...
    !e4.noMermaid && s2 && (s2.initialize({
      startOnLoad: false,
      theme: o2.value === "dark" ? "dark" : "default"
    }), l2.value = l2.value + 1);
  };
  return watch(
    () => o2.value,
    ...
    if (!e4.noMermaid && !(n3 != null && n3.instance)) {
      const s2 = (n3 == null ? void 0 : n3.js) || u;
      if (/\.mjs/.test(s2))
        import(
          /* @vite-ignore */
          /* webpackIgnore: true */
          ...
          t2.value = r3.default, c3();
        });
      else {
        const r3 = document.createElement("script");
        r3.id = `${a}-mermaid`, r3.src = s2, r3.onload = () => {
          t2.value = window.mermaid, c3();
        }, h2(r3, "mermaid");
      }
    }
  }), { mermaidRef: t2, reRenderRef: l2, replaceMermaid: () => {
    nextTick(() => {
      if (!e4.noMermaid && t2.value) {
        const s2 = document.querySelectorAll(
          `div.${a}-mermaid`
        ), r3 = document.createElement("div");
        r3.style.width = document.body.offsetWidth + "px", r3.style.height = document.body.offsetHeight + "px", r3.style.position = "fixed", r3.style.zIndex = "-10000", r3.style.top = "-10000";
        let m4 = s2.length;
        m4 > 0 && document.body.appendChild(r3), s2.forEach(async (f3) => {
          let b4 = i2.get(f3.innerText);
          if (!b4) {
            const g4 = m2(), h3 = t2.value.renderAsync || t2.value.render;
            let w = "";
            try {
              w = await h3(g4, f3.innerText, r3);
            } catch {
            }
            b4 = typeof w == "string" ? w : w.svg, i2.set(f3.innerText, b4);
          }
          const u3 = document.createElement("p");
          u3.className = `${a}-mermaid`, u3.setAttribute("data-processed", ""), u3.innerHTML = b4, f3.dataset.line !== void 0 && (u3.dataset.line = f3.dataset.line), f3.replaceWith(u3), --m4 === 0 && r3.remove();
        });
      }
    });
  } };
...
var xe = (e4) => {
  var t2;
  const o2 = (t2 = l.editorExtensions) == null ? void 0 : t2.katex, a3 = o2 == null ? void 0 : o2.instance, n3 = shallowRef(a3);
  return onMounted(() => {
    if (!e4.noKatex && !n3.value) {
      const l2 = document.createElement("script");
      l2.src = (o2 == null ? void 0 : o2.js) || k.js, l2.onload = () => {
        n3.value = window.katex;
      }, l2.id = `${a}-katex`;
      const i2 = document.createElement("link");
      i2.rel = "stylesheet", i2.href = (o2 == null ? void 0 : o2.css) || k.css, i2.id = `${a}-katexCss`, h2(l2, "katex"), h2(i2);
    }
  }), n3;
};
var Re = xe;
var Ae = (e4, o2) => {
  const a3 = e4.renderer.rules.fence.bind(e4.renderer.rules);
  e4.renderer.rules.fence = (n3, t2, l2, i2, c3) => {
    const d2 = n3[t2], s2 = d2.content.trim();
    if (d2.info === "mermaid") {
      let r3;
      return n3[t2].map && n3[t2].level === 0 && (r3 = n3[t2].map[0], n3[t2].attrSet("data-line", String(r3))), `<div class="${a}-mermaid" ${r3 !== void 0 ? "data-line=" + r3 : ""} data-mermaid-theme=${o2.themeRef.value}>${s2}</div>`;
    }
    return a3(n3, t2, l2, i2, c3);
  };
};
var Le = Ae;
var q = (e4, o2) => {
  let a3 = true, n3 = true;
  const t2 = e4.posMax, l2 = o2 > 0 ? e4.src.charCodeAt(o2 - 1) : -1, i2 = o2 + 1 <= t2 ? e4.src.charCodeAt(o2 + 1) : -1;
  return (l2 === 32 || l2 === 9 || i2 >= 48 && i2 <= 57) && (n3 = false), (i2 === 32 || i2 === 9) && (a3 = false), {
    can_open: a3,
    can_close: n3
  };
};
var Ne = (e4, o2) => {
  ...
  if (e4.src[e4.pos] !== "$")
    return false;
  if (t2 = q(e4, e4.pos), !t2.can_open)
    return o2 || (e4.pending += "$"), e4.pos += 1, true;
  const i2 = e4.pos + 1;
  for (a3 = i2; (a3 = e4.src.indexOf("$", a3)) !== -1; ) {
    for (l2 = a3 - 1; e4.src[l2] === "\\"; )
      l2 -= 1;
    if ((a3 - l2) % 2 == 1)
      break;
    a3 += 1;
  }
  return a3 === -1 ? (o2 || (e4.pending += "$"), e4.pos = i2, true) : a3 - i2 === 0 ? (o2 || (e4.pending += "$$"), e4.pos = i2 + 1, true) : (t2 = q(e4, a3), t2.can_close ? (o2 || (n3 = e4.push("math_inline", "math", 0), n3.markup = "$", n3.content = e4.src.slice(i2, a3)), e4.pos = a3 + 1, true) : (o2 || (e4.pending += "$"), e4.pos = i2, true));
};
var Be = (e4, o2, a3, n3) => {
  let t2, l2, i2, c3, d2 = false, s2 = e4.bMarks[o2] + e4.tShift[o2], r3 = e4.eMarks[o2];
  if (s2 + 2 > r3 || e4.src.slice(s2, s2 + 2) !== "$$")
    return false;
  if (s2 += 2, t2 = e4.src.slice(s2, r3), n3)
    return true;
  for (t2.trim().slice(-2) === "$$" && (t2 = t2.trim().slice(0, -2), d2 = true), i2 = o2; !d2 && (i2++, !(i2 >= a3 || (s2 = e4.bMarks[i2] + e4.tShift[i2], r3 = e4.eMarks[i2], s2 < r3 && e4.tShift[i2] < e4.blkIndent))); )
    e4.src.slice(s2, r3).trim().slice(-2) === "$$" && (c3 = e4.src.slice(0, r3).lastIndexOf("$$"), l2 = e4.src.slice(s2, c3), d2 = true);
  e4.line = i2 + 1;
  const m4 = e4.push("math_block", "math", 0);
  return m4.block = true, m4.content = (t2 && t2.trim() ? t2 + `
` : "") + e4.getLines(o2 + 1, i2, e4.tShift[o2], true) + (l2 && l2.trim() ? l2 : ""), m4.map = [o2, e4.line], m4.markup = "$$", true;
};
var je = (e4, o2) => {
  const a3 = (t2) => {
    if (o2.katexRef.value) {
      const l2 = o2.katexRef.value.renderToString(t2, {
        throwOnError: false
      });
      return `<span class="${a}-katex-inline" data-processed>${l2}</span>`;
    } else
      return `<span class="${a}-katex-inline">${t2}</span>`;
  }, n3 = (t2, l2) => {
    if (o2.katexRef.value) {
      const i2 = o2.katexRef.value.renderToString(t2, {
        throwOnError: false,
        displayMode: true
      });
      return `<p class="${a}-katex-block" data-line=${l2} data-processed>${i2}</p>`;
    } else
      return `<p class="${a}-katex-block" data-line=${l2}>${t2}</p>`;
  };
  e4.inline.ruler.after("escape", "math_inline", Ne), e4.block.ruler.after("blockquote", "math_block", Be, {
    alt: ["paragraph", "reference", "blockquote", "list"]
  }), e4.renderer.rules.math_inline = (t2, l2) => a3(t2[l2].content), e4.renderer.rules.math_block = (t2, l2) => n3(t2[l2].content, t2[l2].map[0]) + `
`;
};
var Oe = je;
var Ue = (e4, o2) => {
  o2 = o2 || {};
  const a3 = 3, n3 = o2.marker || "!", t2 = n3.charCodeAt(0), l2 = n3.length;
  let i2 = "", c3 = "";
  const d2 = (r3, m4, f3, b4, u3) => {
    const g4 = r3[m4];
    return g4.type === "admonition_open" ? (r3[m4].attrPush([
      "class",
      `${a}-admonition ${a}-admonition-${g4.info}`
    ]), r3[m4].attrSet("data-line", String(r3[m4].map[0]))) : g4.type === "admonition_title_open" && r3[m4].attrPush(["class", `${a}-admonition-title`]), u3.renderToken(r3, m4, f3);
  }, s2 = (r3) => {
    const m4 = r3.trim().split(" ", 2);
    c3 = "", i2 = m4[0], m4.length > 1 && (c3 = r3.substring(i2.length + 2)), (c3 === "" || !c3) && (c3 = i2);
  };
  e4.block.ruler.before(
    "code",
    "admonition",
    (r3, m4, f3, b4) => {
      let u3, g4, h3, w = false, v = r3.bMarks[m4] + r3.tShift[m4], k2 = r3.eMarks[m4];
      if (t2 !== r3.src.charCodeAt(v))
        return false;
      for (u3 = v + 1; u3 <= k2 && n3[(u3 - v) % l2] === r3.src[u3]; u3++)
        ;
      const P = Math.floor((u3 - v) / l2);
      if (P !== a3)
        return false;
      u3 -= (u3 - v) % l2;
      const _ = r3.src.slice(v, u3), E = r3.src.slice(u3, k2);
      if (s2(E), b4)
        return true;
      for (g4 = m4; g4++, !(g4 >= f3 || (v = r3.bMarks[g4] + r3.tShift[g4], k2 = r3.eMarks[g4], v < k2 && r3.sCount[g4] < r3.blkIndent)); )
        if (t2 === r3.src.charCodeAt(v) && !(r3.sCount[g4] - r3.blkIndent >= 4)) {
          for (u3 = v + 1; u3 <= k2 && n3[(u3 - v) % l2] === r3.src[u3]; u3++)
            ;
          if (!(Math.floor((u3 - v) / l2) < P) && (u3 -= (u3 - v) % l2, u3 = r3.skipSpaces(u3), !(u3 < k2))) {
            w = true;
            break;
          }
        }
      const oe2 = r3.parentType, ae = r3.lineMax;
      return r3.parentType = "root", r3.lineMax = g4, h3 = r3.push("admonition_open", "div", 1), h3.markup = _, h3.block = true, h3.info = i2, h3.map = [m4, g4], h3 = r3.push("admonition_title_open", "p", 1), h3.markup = _ + " " + i2, h3.map = [m4, g4], h3 = r3.push("inline", "", 0), h3.content = c3, h3.map = [m4, r3.line - 1], h3.children = [], h3 = r3.push("admonition_title_close", "p", -1), h3.markup = _ + " " + i2, r3.md.block.tokenize(r3, m4 + 1, g4), h3 = r3.push("admonition_close", "div", -1), h3.markup = r3.src.slice(v, u3), h3.block = true, r3.parentType = oe2, r3.lineMax = ae, r3.line = g4 + (w ? 1 : 0), true;
    },
    {
      alt: ["paragraph", "reference", "blockquote", "list"]
    }
  ), e4.renderer.rules.admonition_open = d2, e4.renderer.rules.admonition_title_open = d2, e4.renderer.rules.admonition_title_close = d2, e4.renderer.rules.admonition_close = d2;
};
var Ve = Ue;
var Ge = (e4, o2) => {
  e4.renderer.rules.heading_open = (a3, n3) => {
    const t2 = a3[n3], l2 = a3[n3 + 1].content, i2 = t2.markup.length;
    return o2.headsRef.value.push({
      text: l2,
      level: i2
    }), t2.map && t2.level === 0 && (t2.attrSet("data-line", String(t2.map[0])), t2.attrSet(
      "id",
      o2.mdHeadingId(l2, i2, o2.headsRef.value.length)
    )), e4.renderer.renderToken(a3, n3, o2);
  }, e4.renderer.rules.heading_close = (a3, n3, t2, l2, i2) => i2.renderToken(a3, n3, t2);
};
var De = Ge;
var ze = (e4, o2) => {
  const a3 = e4.renderer.rules.fence, n3 = e4.utils.unescapeAll, t2 = /\[(\w*)(?::([\w ]*))?\]/;
  function l2(s2) {
    return s2.info ? n3(s2.info).trim() : "";
  }
  function i2(s2) {
    const r3 = l2(s2), [m4 = null, f3 = ""] = (t2.exec(r3) || []).slice(1);
    return [m4, f3];
  }
  function c3(s2) {
    const r3 = l2(s2);
    return r3 ? r3.split(/(\s+)/g)[0] : "";
  }
  const d2 = (s2, r3, m4, f3, b4) => {
    if (s2[r3].hidden)
      return "";
    const [u3, g4] = i2(s2[r3]);
    if (u3 === null)
      return a3(s2, r3, m4, f3, b4);
    let h3, w, v, k2, P = "", _ = "";
    for (let E = r3; E < s2.length && (h3 = s2[E], [w, v] = i2(h3), w === u3); E++)
      h3.info = h3.info.replace(t2, ""), h3.hidden = true, k2 = E - r3 > 0 ? "" : " checked", P += `<li><input type="radio" name="label-group-${o2.editorId}-${r3}"${k2}><label for="group-${o2.editorId}-${r3}-tab-${E - r3}" onclick="this.previousElementSibling.click()">${v || c3(h3)}</label></li>
`, _ += `<input type="radio" id="group-${o2.editorId}-${r3}-tab-${E - r3}" name="group-${o2.editorId}-${r3}"${k2}>
` + a3(s2, E, m4, f3, b4);
...
var qe = (e4) => {
  [
    ...
    const a3 = e4.renderer.rules[o2];
    a3 ? e4.renderer.rules[o2] = (n3, t2, l2, i2, c3) => {
      let d2;
      const s2 = a3(n3, t2, l2, i2, c3);
      return n3[t2].map && n3[t2].level === 0 ? (d2 = n3[t2].map[0], s2.replace(/^(<[^>]*)/, `$1 data-line="${d2}"`)) : s2;
    } : e4.renderer.rules[o2] = (n3, t2, l2, i2, c3) => {
      let d2;
      return n3[t2].map && n3[t2].level === 0 && (d2 = n3[t2].map[0], n3[t2].attrSet("data-line", String(d2))), c3.renderToken(n3, t2, l2);
    };
  });
};
var We = (e4, o2) => {
  const { editorConfig: a3, markdownItConfig: n3 } = l, t2 = inject("editorId"), l2 = inject("showCodeRowNumber"), i2 = inject("theme"), c3 = ref([]), d2 = Fe(e4), s2 = Re(e4), { reRenderRef: r3, replaceMermaid: m4 } = Me(e4), f3 = (0, import_markdown_it.default)({
    html: true,
    breaks: true
  });
  n3(f3), f3.use(Oe, { katexRef: s2 }), f3.use(r2, { figcaption: true }), f3.use(Ve), f3.use(import_markdown_it_task_lists.default), f3.use(De, { mdHeadingId: e4.mdHeadingId, headsRef: c3 }), f3.use(Ke, { editorId: t2 }), e4.noMermaid || f3.use(Le, { themeRef: i2 }), f3.set({
    highlight: (w, v) => {
      let k2;
      !e4.noHighlight && d2.value ? d2.value.getLanguage(v) ? k2 = d2.value.highlight(w, {
        language: v,
        ignoreIllegals: true
      }).value : k2 = d2.value.highlightAuto(w).value : k2 = f3.utils.escapeHtml(w);
      const P = l2 ? b2(k2.trim()) : `<span class="code-block">${k2.trim()}</span>`;
      return `<pre><code class="language-${v}" language=${v}>${P}</code></pre>`;
    }
  }), qe(f3);
  const b4 = ref(e4.sanitize(f3.render(e4.modelValue))), u3 = () => {
    g2.emit(t2, "buildFinished", b4.value), e4.onHtmlChanged(b4.value), e4.onGetCatalog(c3.value), g2.emit(t2, "catalogChanged", c3.value), m4();
  };
  onMounted(u3);
  const g4 = x(
    async () => {
      c3.value = [], b4.value = e4.sanitize(f3.render(e4.modelValue)), u3();
    },
    (a3 == null ? void 0 : a3.renderDelay) !== void 0 ? a3 == null ? void 0 : a3.renderDelay : o2 ? 0 : 500
  ), h3 = computed(() => (e4.noKatex || s2.value) && (e4.noHighlight || d2.value));
  return watch([toRef(e4, "modelValue"), h3, r3], g4), onMounted(() => {
    g2.on(t2, {
      name: "pushCatalog",
      callback() {
        g2.emit(t2, "catalogChanged", c3.value);
      }
    });
  }), { html: b4 };
};
...
var Xe = defineComponent({
  ...
  props: Je,
  setup(e4) {
    const o2 = inject("editorId"), a3 = inject("previewTheme"), n3 = inject("showCodeRowNumber"), {
      html: t2
    } = Ze(e4, e4.previewOnly);
    return Ee(e4, t2), Pe(e4, t2), () => createVNode(Fragment, null, [createVNode("div", {
      id: `${o2}-preview-wrapper`,
      class: `${a}-preview-wrapper`,
      "data-show": e4.setting.preview,
      key: "content-preview-wrapper"
    }, [createVNode("article", {
      id: `${o2}-preview`,
      class: [`${a}-preview`, `${a3 == null ? void 0 : a3.value}-theme`, n3 && `${a}-scrn`],
      innerHTML: t2.value
...
var ut = (e4, o2) => {
  const { editorId: a3 } = e4, n3 = reactive({
    // 是否已编译成html
    buildFinished: false,
    // 存储当前最新的html
    html: ""
  ...
  watch(
    () => e4.modelValue,
    () => {
      n3.buildFinished = false;
    }
  ), onMounted(() => {
    g2.on(a3, {
      name: "buildFinished",
      callback(t2) {
        n3.buildFinished = true, n3.html = t2;
      }
    }), g2.on(a3, {
      name: Q,
      callback() {
        const t2 = new Promise((l2) => {
          if (n3.buildFinished)
            ...
            const i2 = (c3) => {
              l2(c3), g2.remove(a3, "buildFinished", i2);
            };
            g2.on(a3, {
              name: "buildFinished",
              callback: i2
        ...
        e4.onSave ? e4.onSave(e4.modelValue, t2) : o2.emit("onSave", e4.modelValue, t2);
      }
    });
  });
};
var ee = (e4) => {
  var t2, l2;
  const { editorId: o2 } = e4, a3 = (l2 = (t2 = l) == null ? void 0 : t2.editorExtensions) == null ? void 0 : l2.highlight;
  provide("editorId", o2), provide(
    "theme",
    computed(() => e4.theme)
  ), provide(
    "highlight",
    computed(() => {
      const i2 = {
        ...b,
        ...a3 == null ? void 0 : a3.css
      }, c3 = e4.codeStyleReverse && e4.codeStyleReverseList.includes(e4.previewTheme) ? "dark" : e4.theme;
      return {
        js: (a3 == null ? void 0 : a3.js) || n,
        css: i2[e4.codeTheme] ? i2[e4.codeTheme][c3] : b.atom[c3]
      };
    })
  ...
  const n3 = computed(() => {
    ...
    const i2 = {
      ...p,
      ...(d2 = (c3 = l) == null ? void 0 : c3.editorConfig) == null ? void 0 : d2.languageUserDefined
    };
    return i2[e4.language] ? i2[e4.language] : p["zh-CN"];
  });
  provide("usedLanguageText", n3), provide(
    "previewTheme",
    computed(() => e4.previewTheme)
  );
};
var mt = (e4) => {
  ee(e4), provide("tabWidth", e4.tabWidth);
};
var te = (e4) => {
  onMounted(() => {
    var a3;
    const o2 = document.createElement("script");
    o2.src = ((a3 = l.editorExtensions) == null ? void 0 : a3.iconfont) || r, o2.id = `${a}-icon`, e4.noIconfont || h2(o2);
  });
};
var ft = (e4) => {
  var c3, d2, s2, r3, m4, f3;
  const { noPrettier: o2, noUploadImg: a3 } = e4, { editorExtensions: n3 } = l, t2 = o2 || !!((d2 = (c3 = l.editorExtensions) == null ? void 0 : c3.prettier) != null && d2.prettierInstance), l2 = o2 || !!((r3 = (s2 = l.editorExtensions) == null ? void 0 : s2.prettier) != null && r3.parserMarkdownInstance), i2 = a3 || !!((f3 = (m4 = l.editorExtensions) == null ? void 0 : m4.cropper) != null && f3.instance);
  onMounted(() => {
    var w, v, k2, P;
    const b4 = document.createElement("script"), u3 = document.createElement("script");
    b4.src = ((w = n3 == null ? void 0 : n3.prettier) == null ? void 0 : w.standaloneJs) || c.main, b4.id = `${a}-prettier`, u3.src = ((v = n3 == null ? void 0 : n3.prettier) == null ? void 0 : v.parserMarkdownJs) || c.markdown, u3.id = `${a}-prettierMD`;
    const g4 = document.createElement("link");
    g4.rel = "stylesheet", g4.href = ((k2 = n3 == null ? void 0 : n3.cropper) == null ? void 0 : k2.css) || d.css, g4.id = `${a}-cropperCss`;
    const h3 = document.createElement("script");
    h3.src = ((P = n3 == null ? void 0 : n3.cropper) == null ? void 0 : P.js) || d.js, h3.id = `${a}-cropper`, i2 || (h2(g4), h2(h3)), t2 || h2(b4), l2 || h2(u3);
  }), te(e4);
};
var ht = (e4, o2) => {
  const { editorId: a3 } = e4, n3 = reactive({
    ...
    n3[c3] = d2 === void 0 ? !n3[c3] : d2, c3 === "preview" && n3.preview ? n3.htmlPreview = false : c3 === "htmlPreview" && n3.htmlPreview && (n3.preview = false);
  };
  let l2 = "";
  const i2 = () => {
    n3.pageFullscreen || n3.fullscreen ? document.body.style.overflow = "hidden" : document.body.style.overflow = l2;
  };
  return watch(() => [n3.pageFullscreen, n3.fullscreen], i2), onMounted(() => {
    g2.on(a3, {
      name: "uploadImage",
      callback(c3, d2) {
        const s2 = (r3) => {
          g2.emit(a3, "replace", "image", {
            desc: "",
            urls: r3
          }), d2 && d2();
        };
        e4.onUploadImg ? e4.onUploadImg(c3, s2) : o2.emit("onUploadImg", c3, s2);
      }
    }), l2 = document.body.style.overflow, i2();
  }), [n3, t2];
};
var pt = (e4) => {
  const { editorId: o2 } = e4, a3 = ref(false);
  return onMounted(() => {
    g2.on(o2, {
      name: Y,
      callback: (t2) => {
        t2 === void 0 ? a3.value = !a3.value : a3.value = t2;
      }
    });
  }), computed(() => !e4.toolbarsExclude.includes("catalog") && e4.toolbars.includes("catalog") && a3.value);
};
var gt = (e4, o2, a3, n3, t2) => {
  ...
  const i2 = {
    ...
    insert(c3) {
      g2.emit(l2, "replace", "universal", { generate: c3 });
    },
    focus(c3) {
      g2.emit(l2, Se, c3);
    }
...
var re = ["onHtmlChanged", "onGetCatalog"];
var yt = [
  ...re,
  "onChange",
  "onSave",
...
var Ye = defineComponent({
  ...
  setup(e4, o2) {
    ...
    return ee(e4), te(e4), onBeforeUnmount(() => {
      g2.clear(a3);
    }), () => createVNode("div", {
      id: a3,
      ...
      onHtmlChanged: (i2) => {
        e4.onHtmlChanged ? e4.onHtmlChanged(i2) : o2.emit("onHtmlChanged", i2);
      },
      onGetCatalog: (i2) => {
        e4.onGetCatalog ? e4.onGetCatalog(i2) : o2.emit("onGetCatalog", i2);
      },
...
var B2 = defineComponent({
  props: T,
  setup(e4, a3) {
    const c3 = ref(e4.visible), o2 = ref([`${a}-modal`]), d2 = ref(), m4 = ref();
    let f3 = () => {
    };
    const l2 = reactive({
      initPos: {
    ...
    return onMounted(() => {
      f3 = L2(m4.value, (s2, i2) => {
        l2.initPos.left = s2 + "px", l2.initPos.top = i2 + "px";
      });
    }), onBeforeUnmount(() => {
      f3();
    }), watch(() => e4.isFullscreen, (s2) => {
      s2 ? f3() : f3 = L2(m4.value, (i2, u3) => {
        l2.initPos.left = i2 + "px", l2.initPos.top = u3 + "px";
      });
    }), watch(() => e4.visible, (s2) => {
      s2 ? (o2.value.push("zoom-in"), c3.value = s2, nextTick(() => {
        const i2 = d2.value.offsetWidth / 2, u3 = d2.value.offsetHeight / 2, F2 = document.documentElement.clientWidth / 2, k2 = document.documentElement.clientHeight / 2;
        l2.initPos.left = F2 - i2 + "px", l2.initPos.top = k2 - u3 + "px";
      }), setTimeout(() => {
        o2.value = o2.value.filter((i2) => i2 !== "zoom-in");
      }, 140)) : (o2.value.push("zoom-out"), setTimeout(() => {
        o2.value = o2.value.filter((i2) => i2 !== "zoom-out"), c3.value = s2;
      }, 130));
    }), () => {
      const s2 = s({
        ctx: a3
      ...
      return createVNode("div", {
        ...
        onClick: (u3) => {
          u3.stopPropagation(), e4.isFullscreen ? l2.initPos = l2.historyPos : (l2.historyPos = l2.initPos, l2.initPos = {
            left: "0",
            top: "0"
        ...
        class: `${a}-modal-close`,
        onClick: (u3) => {
          u3.stopPropagation(), e4.onClose && e4.onClose();
        }
      }, [createVNode("svg", {
        class: `${a}-icon`,
        "aria-hidden": "true"
...
function M2(e4) {
  return typeof e4 == "function" || Object.prototype.toString.call(e4) === "[object Object]" && !isVNode(e4);
}
var z2 = {
  title: {
    type: String,
  ...
  setup(e4, a3) {
    return () => {
      ...
      return createVNode(Fragment, null, [createVNode("div", {
        ...
        title: e4.title,
        onClick: () => {
          e4.onClick instanceof Function ? e4.onClick() : a3.emit("onClick");
        }
      }, [c3]), createVNode(B2, {
        width: e4.width,
        height: e4.height,
        ...
        visible: e4.visible,
        onClose: () => {
          e4.onClose instanceof Function ? e4.onClose() : a3.emit("onClose");
        },
        showAdjust: e4.showAdjust,
        isFullscreen: e4.isFullscreen,
        onAdjust: (d2) => {
          e4.onAdjust instanceof Function ? e4.onAdjust(d2) : a3.emit("onAdjust", d2);
        }
      }, M2(o2) ? o2 : {
        default: () => [o2]
      })]);
...
g3.install = (e4) => (e4.component(g3.name, g3), e4);
...
function changeBlockComment(option, state, ranges = state.selection.ranges) {
  ...
  if (!tokens.every((c3) => c3))
    return null;
  let comments = ranges.map((r3, i2) => findBlockComment(state, tokens[i2], r3.from, r3.to));
...
var historyConfig = Facet.define({
  combine(configs) {
    return combineConfig(configs, {
      ...
      joinToEvent: (a3, b4) => (tr, adj) => a3(tr, adj) || b4(tr, adj)
    });
  }
});
...
function isAdjacent(a3, b4) {
  let ranges = [], isAdjacent2 = false;
  a3.iterChangedRanges((f3, t2) => ranges.push(f3, t2));
  b4.iterChangedRanges((_f, _t2, f3, t2) => {
...
function eqSelectionShape(a3, b4) {
  return a3.ranges.length == b4.ranges.length && a3.ranges.filter((r3, i2) => r3.empty != b4.ranges[i2].empty).length === 0;
}
function conc(a3, b4) {
  return !a3.length ? b4 : !b4.length ? a3 : a3.concat(b4);
}
var none = [];
...
var highlightConfig = Facet.define({
  combine(options) {
    return combineConfig(options, defaultHighlightOptions, {
      highlightWordAroundCursor: (a3, b4) => a3 || b4,
...
var RegExpQuery = class extends QueryType {
  ...
  getReplacement(result) {
    return this.spec.unquote(this.spec.replace.replace(/\$([$&\d+])/g, (m4, i2) => i2 == "$" ? "$" : i2 == "&" ? result.match[0] : i2 != "0" && +i2 < result.match.length ? result.match[i2] : m4));
  }
  matchAll(state, limit) {
  ...
  run() {
    ...
    if (now < this.lintTime - 10) {
      ...
      Promise.all(sources.map((source) => Promise.resolve(source(this.view)))).then((annotations) => {
        let all = annotations.reduce((a3, b4) => a3.concat(b4));
...
var lintConfig = Facet.define({
  combine(input) {
    return Object.assign({ sources: input.map((i2) => i2.source) }, combineConfig(input.map((i2) => i2.config), {
      ...
      needsRefresh: (a3, b4) => !a3 ? b4 : !b4 ? a3 : (u3) => a3(u3) || b4(u3)
    }));
  }
});
...
function sql(dialectName) {
  return import("./dist-ZZGY72PT.js").then((m4) => m4.sql({ dialect: m4[dialectName] }));
}
var languages = [
  ...
  LanguageDescription.of({
    ...
    extensions: ["c", "h", "ino"],
    load() {
      return import("./dist-7XVJZYWI.js").then((m4) => m4.cpp());
    }
  }),
  LanguageDescription.of({
    name: "C++",
  ...
  LanguageDescription.of({
    ...
    extensions: ["css"],
    load() {
      return import("./dist-K4YFHPAU.js").then((m4) => m4.css());
    }
  }),
  LanguageDescription.of({
    name: "HTML",
    ...
    load() {
      return import("./dist-O7GITS5M.js").then((m4) => m4.html());
    }
  }),
  LanguageDescription.of({
    name: "Java",
    extensions: ["java"],
    load() {
      return import("./dist-4PBKS4PU.js").then((m4) => m4.java());
    }
  }),
  LanguageDescription.of({
    name: "JavaScript",
    ...
    load() {
      return import("./dist-4V2W2TVS.js").then((m4) => m4.javascript());
    }
  }),
  LanguageDescription.of({
    name: "JSON",
    ...
    extensions: ["json", "map"],
    load() {
      return import("./dist-V2BACPDM.js").then((m4) => m4.json());
    }
  }),
  LanguageDescription.of({
    name: "JSX",
    extensions: ["jsx"],
    load() {
      return import("./dist-4V2W2TVS.js").then((m4) => m4.javascript({ jsx: true }));
    }
  }),
  LanguageDescription.of({
    name: "LESS",
    extensions: ["less"],
    load() {
      return import("./dist-Y77Z3RRM.js").then((m4) => m4.less());
    }
  }),
  LanguageDescription.of({
    name: "MariaDB SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-4Z2HW7VT.js").then((m4) => m4.markdown());
    }
  }),
  LanguageDescription.of({
    name: "MS SQL",
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./dist-SGZSIUCW.js").then((m4) => m4.php());
    }
  }),
  LanguageDescription.of({
    name: "PLSQL",
  ...
  LanguageDescription.of({
    ...
    filename: /^(BUCK|BUILD)$/,
    load() {
      return import("./dist-RDO6JV2J.js").then((m4) => m4.python());
    }
  }),
  LanguageDescription.of({
    name: "Rust",
    extensions: ["rs"],
    load() {
      return import("./dist-GPPGIUJI.js").then((m4) => m4.rust());
    }
  }),
  LanguageDescription.of({
    name: "Sass",
    extensions: ["sass"],
    load() {
      return import("./dist-PPHGG4ME.js").then((m4) => m4.sass({ indented: true }));
    }
  }),
  LanguageDescription.of({
    name: "SCSS",
    extensions: ["scss"],
    load() {
      return import("./dist-PPHGG4ME.js").then((m4) => m4.sass());
    }
  }),
  LanguageDescription.of({
    name: "SQL",
  ...
  LanguageDescription.of({
    ...
    extensions: ["tsx"],
    load() {
      return import("./dist-4V2W2TVS.js").then((m4) => m4.javascript({ jsx: true, typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "TypeScript",
    ...
    extensions: ["ts"],
    load() {
      return import("./dist-4V2W2TVS.js").then((m4) => m4.javascript({ typescript: true }));
    }
  }),
  LanguageDescription.of({
    name: "WebAssembly",
    extensions: ["wat", "wast"],
    load() {
      return import("./dist-553VBR5M.js").then((m4) => m4.wast());
    }
  }),
  LanguageDescription.of({
    name: "XML",
    ...
    load() {
      return import("./dist-6EOYH4TP.js").then((m4) => m4.xml());
    }
  }),
  ...
  LanguageDescription.of({
    ...
    load() {
      return import("./apl-DXGT7VBL.js").then((m4) => legacy(m4.apl));
    }
  }),
  LanguageDescription.of({
    name: "PGP",
    ...
    load() {
      return import("./asciiarmor-MQEVB3RM.js").then((m4) => legacy(m4.asciiArmor));
    }
  }),
  LanguageDescription.of({
    name: "ASN.1",
    extensions: ["asn", "asn1"],
    load() {
      return import("./asn1-V4S3IBGD.js").then((m4) => legacy(m4.asn1({})));
    }
  }),
  LanguageDescription.of({
    name: "Asterisk",
    ...
    load() {
      return import("./asterisk-5QZ2F26P.js").then((m4) => legacy(m4.asterisk));
    }
  }),
  LanguageDescription.of({
    name: "Brainfuck",
    extensions: ["b", "bf"],
    load() {
      return import("./brainfuck-XX46VHSW.js").then((m4) => legacy(m4.brainfuck));
    }
  }),
  LanguageDescription.of({
    name: "Cobol",
    extensions: ["cob", "cpy"],
    load() {
      return import("./cobol-IYVAKP42.js").then((m4) => legacy(m4.cobol));
    }
  }),
  LanguageDescription.of({
    name: "C#",
    ...
    extensions: ["cs"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.csharp));
    }
  }),
  LanguageDescription.of({
    name: "Clojure",
    ...
    load() {
      return import("./clojure-YBDRJRBS.js").then((m4) => legacy(m4.clojure));
    }
  }),
  LanguageDescription.of({
    name: "ClojureScript",
  ...
  LanguageDescription.of({
    ...
    extensions: ["gss"],
    load() {
      return import("./css-YS4Z3RLV.js").then((m4) => legacy(m4.gss));
    }
  }),
  LanguageDescription.of({
    name: "CMake",
    ...
    load() {
      return import("./cmake-RQ6FHGCX.js").then((m4) => legacy(m4.cmake));
    }
  }),
  LanguageDescription.of({
    name: "CoffeeScript",
    ...
    extensions: ["coffee"],
    load() {
      return import("./coffeescript-VNCHJRGD.js").then((m4) => legacy(m4.coffeeScript));
    }
  }),
  LanguageDescription.of({
    name: "Common Lisp",
    ...
    load() {
      return import("./commonlisp-PYWPLL3D.js").then((m4) => legacy(m4.commonLisp));
    }
  }),
  LanguageDescription.of({
    name: "Cypher",
    ...
    load() {
      return import("./cypher-C2Y3TLUX.js").then((m4) => legacy(m4.cypher));
    }
  }),
  LanguageDescription.of({
    name: "Cython",
    ...
    load() {
      return import("./python-RJ4ZLGRY.js").then((m4) => legacy(m4.cython));
    }
  }),
  LanguageDescription.of({
    name: "Crystal",
    extensions: ["cr"],
    load() {
      return import("./crystal-PPC5DURK.js").then((m4) => legacy(m4.crystal));
    }
  }),
  LanguageDescription.of({
    name: "D",
    extensions: ["d"],
    load() {
      return import("./d-QDZAH2TM.js").then((m4) => legacy(m4.d));
    }
  }),
  LanguageDescription.of({
    name: "Dart",
    extensions: ["dart"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.dart));
    }
  }),
  LanguageDescription.of({
    name: "diff",
    ...
    load() {
      return import("./diff-JW6OMZCR.js").then((m4) => legacy(m4.diff));
    }
  }),
  LanguageDescription.of({
    name: "Dockerfile",
    filename: /^Dockerfile$/,
    load() {
      return import("./dockerfile-FYDPE2O2.js").then((m4) => legacy(m4.dockerFile));
    }
  }),
  LanguageDescription.of({
    name: "DTD",
    extensions: ["dtd"],
    load() {
      return import("./dtd-T5V3DMRV.js").then((m4) => legacy(m4.dtd));
    }
  }),
  LanguageDescription.of({
    name: "Dylan",
    ...
    load() {
      return import("./dylan-MD4MLZUZ.js").then((m4) => legacy(m4.dylan));
    }
  }),
  LanguageDescription.of({
    name: "EBNF",
    load() {
      return import("./ebnf-MZQSTAFS.js").then((m4) => legacy(m4.ebnf));
    }
  }),
  LanguageDescription.of({
    name: "ECL",
    extensions: ["ecl"],
    load() {
      return import("./ecl-ICPEC5CG.js").then((m4) => legacy(m4.ecl));
    }
  }),
  LanguageDescription.of({
    name: "edn",
  ...
  LanguageDescription.of({
    ...
    extensions: ["e"],
    load() {
      return import("./eiffel-P54BXHPE.js").then((m4) => legacy(m4.eiffel));
    }
  }),
  LanguageDescription.of({
    name: "Elm",
    extensions: ["elm"],
    load() {
      return import("./elm-ZV76SDWN.js").then((m4) => legacy(m4.elm));
    }
  }),
  LanguageDescription.of({
    name: "Erlang",
    extensions: ["erl"],
    load() {
      return import("./erlang-NIZCRXWL.js").then((m4) => legacy(m4.erlang));
    }
  }),
  LanguageDescription.of({
    name: "Esper",
    load() {
      return import("./sql-ZS7YW57Y.js").then((m4) => legacy(m4.esper));
    }
  }),
  LanguageDescription.of({
    name: "Factor",
    extensions: ["factor"],
    load() {
      return import("./factor-7YUST7CX.js").then((m4) => legacy(m4.factor));
    }
  }),
  LanguageDescription.of({
    name: "FCL",
    load() {
      return import("./fcl-UZGWANZ7.js").then((m4) => legacy(m4.fcl));
    }
  }),
  LanguageDescription.of({
    name: "Forth",
    ...
    load() {
      return import("./forth-YOEDQXK2.js").then((m4) => legacy(m4.forth));
    }
  }),
  LanguageDescription.of({
    name: "Fortran",
    ...
    load() {
      return import("./fortran-TKRRVTHB.js").then((m4) => legacy(m4.fortran));
    }
  }),
  LanguageDescription.of({
    name: "F#",
    ...
    extensions: ["fs"],
    load() {
      return import("./mllike-RAY26D4D.js").then((m4) => legacy(m4.fSharp));
    }
  }),
  LanguageDescription.of({
    name: "Gas",
    extensions: ["s"],
    load() {
      return import("./gas-J2LUVTAT.js").then((m4) => legacy(m4.gas));
    }
  }),
  LanguageDescription.of({
    name: "Gherkin",
    extensions: ["feature"],
    load() {
      return import("./gherkin-6E73IR4X.js").then((m4) => legacy(m4.gherkin));
    }
  }),
  LanguageDescription.of({
    name: "Go",
    extensions: ["go"],
    load() {
      return import("./go-IP6N6VEF.js").then((m4) => legacy(m4.go));
    }
  }),
  LanguageDescription.of({
    name: "Groovy",
    ...
    load() {
      return import("./groovy-SITCLL6L.js").then((m4) => legacy(m4.groovy));
    }
  }),
  LanguageDescription.of({
    name: "Haskell",
    extensions: ["hs"],
    load() {
      return import("./haskell-6YH7QKCT.js").then((m4) => legacy(m4.haskell));
    }
  }),
  LanguageDescription.of({
    name: "Haxe",
    extensions: ["hx"],
    load() {
      return import("./haxe-DNR6PRLP.js").then((m4) => legacy(m4.haxe));
    }
  }),
  LanguageDescription.of({
    name: "HXML",
    extensions: ["hxml"],
    load() {
      return import("./haxe-DNR6PRLP.js").then((m4) => legacy(m4.hxml));
    }
  }),
  LanguageDescription.of({
    name: "HTTP",
    load() {
      return import("./http-K4MEN3XG.js").then((m4) => legacy(m4.http));
    }
  }),
  LanguageDescription.of({
    name: "IDL",
    extensions: ["pro"],
    load() {
      return import("./idl-MSQBBKR3.js").then((m4) => legacy(m4.idl));
    }
  }),
  LanguageDescription.of({
    name: "JSON-LD",
    ...
    extensions: ["jsonld"],
    load() {
      return import("./javascript-HNXZNRVH.js").then((m4) => legacy(m4.jsonld));
    }
  }),
  LanguageDescription.of({
    name: "Jinja2",
    ...
    load() {
      return import("./jinja2-IQ27HRJZ.js").then((m4) => legacy(m4.jinja2));
    }
  }),
  LanguageDescription.of({
    name: "Julia",
    extensions: ["jl"],
    load() {
      return import("./julia-PI6TSUDH.js").then((m4) => legacy(m4.julia));
    }
  }),
  LanguageDescription.of({
    name: "Kotlin",
    extensions: ["kt"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.kotlin));
    }
  }),
  LanguageDescription.of({
    name: "LiveScript",
    ...
    extensions: ["ls"],
    load() {
      return import("./livescript-BVEL6VCP.js").then((m4) => legacy(m4.liveScript));
    }
  }),
  LanguageDescription.of({
    name: "Lua",
    extensions: ["lua"],
    load() {
      return import("./lua-HOP4V42U.js").then((m4) => legacy(m4.lua));
    }
  }),
  LanguageDescription.of({
    name: "mIRC",
    extensions: ["mrc"],
    load() {
      return import("./mirc-7K3UDM2S.js").then((m4) => legacy(m4.mirc));
    }
  }),
  LanguageDescription.of({
    name: "Mathematica",
    ...
    load() {
      return import("./mathematica-7FOE7LWG.js").then((m4) => legacy(m4.mathematica));
    }
  }),
  LanguageDescription.of({
    name: "Modelica",
    extensions: ["mo"],
    load() {
      return import("./modelica-IRUDF65Y.js").then((m4) => legacy(m4.modelica));
    }
  }),
  LanguageDescription.of({
    name: "MUMPS",
    extensions: ["mps"],
    load() {
      return import("./mumps-PDXWB4NE.js").then((m4) => legacy(m4.mumps));
    }
  }),
  LanguageDescription.of({
    name: "Mbox",
    extensions: ["mbox"],
    load() {
      return import("./mbox-2D3ZKSG4.js").then((m4) => legacy(m4.mbox));
    }
  }),
  LanguageDescription.of({
    name: "Nginx",
    ...
    load() {
      return import("./nginx-7X3XLPRD.js").then((m4) => legacy(m4.nginx));
    }
  }),
  LanguageDescription.of({
    name: "NSIS",
    extensions: ["nsh", "nsi"],
    load() {
      return import("./nsis-YPYB7P2U.js").then((m4) => legacy(m4.nsis));
    }
  }),
  LanguageDescription.of({
    name: "NTriples",
    extensions: ["nt", "nq"],
    load() {
      return import("./ntriples-JCYBZE4A.js").then((m4) => legacy(m4.ntriples));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C",
    ...
    extensions: ["m"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.objectiveC));
    }
  }),
  LanguageDescription.of({
    name: "Objective-C++",
    ...
    extensions: ["mm"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.objectiveCpp));
    }
  }),
  LanguageDescription.of({
    name: "OCaml",
    ...
    load() {
      return import("./mllike-RAY26D4D.js").then((m4) => legacy(m4.oCaml));
    }
  }),
  LanguageDescription.of({
    name: "Octave",
    extensions: ["m"],
    load() {
      return import("./octave-ECTSTJ4G.js").then((m4) => legacy(m4.octave));
    }
  }),
  LanguageDescription.of({
    name: "Oz",
    extensions: ["oz"],
    load() {
      return import("./oz-CXCHK6VP.js").then((m4) => legacy(m4.oz));
    }
  }),
  LanguageDescription.of({
    name: "Pascal",
    extensions: ["p", "pas"],
    load() {
      return import("./pascal-GONBMP7S.js").then((m4) => legacy(m4.pascal));
    }
  }),
  LanguageDescription.of({
    name: "Perl",
    extensions: ["pl", "pm"],
    load() {
      return import("./perl-YCCFNTPG.js").then((m4) => legacy(m4.perl));
    }
  }),
  LanguageDescription.of({
    name: "Pig",
    extensions: ["pig"],
    load() {
      return import("./pig-NFOW6QRX.js").then((m4) => legacy(m4.pig));
    }
  }),
  LanguageDescription.of({
    name: "PowerShell",
    ...
    load() {
      return import("./powershell-CCXMR2L7.js").then((m4) => legacy(m4.powerShell));
    }
  }),
  LanguageDescription.of({
    ...
    load() {
      return import("./properties-FNPPUCUX.js").then((m4) => legacy(m4.properties));
    }
  }),
  LanguageDescription.of({
    name: "ProtoBuf",
    extensions: ["proto"],
    load() {
      return import("./protobuf-KGN7QILY.js").then((m4) => legacy(m4.protobuf));
    }
  }),
  LanguageDescription.of({
    name: "Puppet",
    extensions: ["pp"],
    load() {
      return import("./puppet-PZKZXDBY.js").then((m4) => legacy(m4.puppet));
    }
  }),
  LanguageDescription.of({
    name: "Q",
    extensions: ["q"],
    load() {
      return import("./q-X5SKF6PP.js").then((m4) => legacy(m4.q));
    }
  }),
  LanguageDescription.of({
    name: "R",
    ...
    extensions: ["r", "R"],
    load() {
      return import("./r-UN6RIFP3.js").then((m4) => legacy(m4.r));
    }
  }),
  LanguageDescription.of({
    name: "RPM Changes",
    load() {
      return import("./rpm-BUPIN2IW.js").then((m4) => legacy(m4.rpmChanges));
    }
  }),
  LanguageDescription.of({
    name: "RPM Spec",
    extensions: ["spec"],
    load() {
      return import("./rpm-BUPIN2IW.js").then((m4) => legacy(m4.rpmSpec));
    }
  }),
  LanguageDescription.of({
    name: "Ruby",
    ...
    load() {
      return import("./ruby-PECA2FVU.js").then((m4) => legacy(m4.ruby));
    }
  }),
  LanguageDescription.of({
    name: "SAS",
    extensions: ["sas"],
    load() {
      return import("./sas-IGLQUT3L.js").then((m4) => legacy(m4.sas));
    }
  }),
  LanguageDescription.of({
    name: "Scala",
    extensions: ["scala"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.scala));
    }
  }),
  LanguageDescription.of({
    name: "Scheme",
    extensions: ["scm", "ss"],
    load() {
      return import("./scheme-TAMBN32T.js").then((m4) => legacy(m4.scheme));
    }
  }),
  LanguageDescription.of({
    name: "Shell",
    ...
    filename: /^PKGBUILD$/,
    load() {
      return import("./shell-DHRYDYIQ.js").then((m4) => legacy(m4.shell));
    }
  }),
  LanguageDescription.of({
    name: "Sieve",
    ...
    load() {
      return import("./sieve-2HGHHBVB.js").then((m4) => legacy(m4.sieve));
    }
  }),
  LanguageDescription.of({
    name: "Smalltalk",
    extensions: ["st"],
    load() {
      return import("./smalltalk-BAHIZSOR.js").then((m4) => legacy(m4.smalltalk));
    }
  }),
  LanguageDescription.of({
    name: "Solr",
    load() {
      return import("./solr-MKZQ4EZ7.js").then((m4) => legacy(m4.solr));
    }
  }),
  LanguageDescription.of({
    name: "SML",
    ...
    load() {
      return import("./mllike-RAY26D4D.js").then((m4) => legacy(m4.sml));
    }
  }),
  LanguageDescription.of({
    name: "SPARQL",
    ...
    load() {
      return import("./sparql-IRSALDRO.js").then((m4) => legacy(m4.sparql));
    }
  }),
  LanguageDescription.of({
    name: "Spreadsheet",
    alias: ["excel", "formula"],
    load() {
      return import("./spreadsheet-NIQWIKFB.js").then((m4) => legacy(m4.spreadsheet));
    }
  }),
  LanguageDescription.of({
    name: "Squirrel",
    extensions: ["nut"],
    load() {
      return import("./clike-R34YWG7R.js").then((m4) => legacy(m4.squirrel));
    }
  }),
  LanguageDescription.of({
    name: "Stylus",
    extensions: ["styl"],
    load() {
      return import("./stylus-OIJS5OAW.js").then((m4) => legacy(m4.stylus));
    }
  }),
  LanguageDescription.of({
    name: "Swift",
    extensions: ["swift"],
    load() {
      return import("./swift-7W6MUL66.js").then((m4) => legacy(m4.swift));
    }
  }),
  LanguageDescription.of({
    name: "sTeX",
    load() {
      return import("./stex-AES7TUVJ.js").then((m4) => legacy(m4.stex));
    }
  }),
  LanguageDescription.of({
    name: "LaTeX",
  ...
  LanguageDescription.of({
    ...
    extensions: ["v", "sv", "svh"],
    load() {
      return import("./verilog-62SZRYYX.js").then((m4) => legacy(m4.verilog));
    }
  }),
  LanguageDescription.of({
    name: "Tcl",
    extensions: ["tcl"],
    load() {
      return import("./tcl-AQTG2GXJ.js").then((m4) => legacy(m4.tcl));
    }
  }),
  LanguageDescription.of({
    name: "Textile",
    extensions: ["textile"],
    load() {
      return import("./textile-I2SMDJSB.js").then((m4) => legacy(m4.textile));
    }
  }),
  LanguageDescription.of({
    name: "TiddlyWiki",
    load() {
      return import("./tiddlywiki-ZVSTDSTE.js").then((m4) => legacy(m4.tiddlyWiki));
    }
  }),
  LanguageDescription.of({
    name: "Tiki wiki",
    load() {
      return import("./tiki-DNAM66NR.js").then((m4) => legacy(m4.tiki));
    }
  }),
  LanguageDescription.of({
    name: "TOML",
    extensions: ["toml"],
    load() {
      return import("./toml-RPF6OCVT.js").then((m4) => legacy(m4.toml));
    }
  }),
  LanguageDescription.of({
    name: "Troff",
    ...
    load() {
      return import("./troff-VS5T2MAG.js").then((m4) => legacy(m4.troff));
    }
  }),
  LanguageDescription.of({
    name: "TTCN",
    ...
    load() {
      return import("./ttcn-CF5XO2FI.js").then((m4) => legacy(m4.ttcn));
    }
  }),
  LanguageDescription.of({
    name: "TTCN_CFG",
    extensions: ["cfg"],
    load() {
      return import("./ttcn-cfg-NM7MMHPS.js").then((m4) => legacy(m4.ttcnCfg));
    }
  }),
  LanguageDescription.of({
    name: "Turtle",
    extensions: ["ttl"],
    load() {
      return import("./turtle-T5NDPEK7.js").then((m4) => legacy(m4.turtle));
    }
  }),
  LanguageDescription.of({
    name: "Web IDL",
    extensions: ["webidl"],
    load() {
      return import("./webidl-JWTCGSNE.js").then((m4) => legacy(m4.webIDL));
    }
  }),
  LanguageDescription.of({
    name: "VB.NET",
    extensions: ["vb"],
    load() {
      return import("./vb-ZOZ6VIGQ.js").then((m4) => legacy(m4.vb));
    }
  }),
  LanguageDescription.of({
    name: "VBScript",
    extensions: ["vbs"],
    load() {
      return import("./vbscript-O32EVXIK.js").then((m4) => legacy(m4.vbScript));
    }
  }),
  LanguageDescription.of({
    name: "Velocity",
    extensions: ["vtl"],
    load() {
      return import("./velocity-TIVWZ76U.js").then((m4) => legacy(m4.velocity));
    }
  }),
  LanguageDescription.of({
    name: "Verilog",
  ...
  LanguageDescription.of({
    ...
    extensions: ["vhd", "vhdl"],
    load() {
      return import("./vhdl-XHKO7YDF.js").then((m4) => legacy(m4.vhdl));
    }
  }),
  LanguageDescription.of({
    name: "XQuery",
    ...
    load() {
      return import("./xquery-YOCQRRZ7.js").then((m4) => legacy(m4.xQuery));
    }
  }),
  LanguageDescription.of({
    name: "Yacas",
    extensions: ["ys"],
    load() {
      return import("./yacas-LIXJIHOV.js").then((m4) => legacy(m4.yacas));
    }
  }),
  LanguageDescription.of({
    name: "YAML",
    ...
    extensions: ["yaml", "yml"],
    load() {
      return import("./yaml-J2RECRRU.js").then((m4) => legacy(m4.yaml));
    }
  }),
  LanguageDescription.of({
    name: "Z80",
    extensions: ["z80"],
    load() {
      return import("./z80-XVPAIWBV.js").then((m4) => legacy(m4.z80));
    }
  }),
  LanguageDescription.of({
    name: "MscGen",
    ...
    load() {
      return import("./mscgen-355JA24P.js").then((m4) => legacy(m4.mscgen));
    }
  }),
  LanguageDescription.of({
    name: "Xù",
    extensions: ["xu"],
    load() {
      return import("./mscgen-355JA24P.js").then((m4) => legacy(m4.xu));
    }
  }),
  LanguageDescription.of({
    name: "MsGenny",
    extensions: ["msgenny"],
    load() {
      return import("./mscgen-355JA24P.js").then((m4) => legacy(m4.msgenny));
    }
  }),
  LanguageDescription.of({
    name: "Vue",
    extensions: ["vue"],
    load() {
      return import("./dist-6GCBQMQF.js").then((m4) => m4.vue());
    }
  }),
  LanguageDescription.of({
    name: "Angular Template",
    load() {
      return import("./dist-6DJSXTZY.js").then((m4) => m4.angular());
    }
  })
];
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        onClick: (s2) => {
          ...
          const g4 = i2(o2.text, o2.level, o2.index), d2 = document.getElementById(g4), e4 = n3 instanceof Element ? n3 : document.querySelector(n3);
          if (d2 && e4) {
...
var F = defineComponent({
  ...
  emits: ["onClick"],
  setup(l2, o2) {
    const i2 = l2.editorId, n3 = reactive({
      list: [],
      show: false,
      scrollElement: l2.scrollElement || `#${i2}-preview-wrapper`
      ...
      const {
        ...
        const a3 = document.getElementById(l2.mdHeadingId(p3.text, p3.level, k2 + 1));
        if (a3 instanceof HTMLElement) {
          const r3 = s2(), m4 = R(a3, r3);
          if (m4 < l2.offsetTop && m4 > c3.minTop)
            return {
              activeHead: p3,
              minTop: m4
            };
    ...
    return onMounted(() => {
      var t2;
      const e4 = s2();
      (t2 = e4 === document.documentElement ? window : e4) == null || t2.addEventListener("scroll", d2), g2.on(i2, {
        name: "catalogChanged",
        callback: (c3) => {
          g4(c3);
        }
      }), g2.emit(i2, "pushCatalog");
    }), onBeforeUnmount(() => {
      var t2;
      const e4 = s2();
  ...
  setup(t2, o2) {
    return () => {
      ...
      return createVNode("div", {
        ...
        title: t2.title,
        onClick: (i2) => {
          t2.onClick instanceof Function ? t2.onClick(i2) : o2.emit("onClick", i2);
        }
      }, [n3]);
    };
  }
...
var Je2 = (e4, o2, a3) => o2 in e4 ? Ze2(e4, o2, { enumerable: true, configurable: true, writable: true, value: a3 }) : e4[o2] = a3;
var U = (e4, o2, a3) => (Je2(e4, typeof o2 != "symbol" ? o2 + "" : o2, a3), a3);
...
var Pt = (e4) => {
  ...
  let a3 = (u3 = (f3 = l.editorExtensions) == null ? void 0 : f3.screenfull) == null ? void 0 : u3.instance;
  const l2 = (v = (d2 = l.editorExtensions) == null ? void 0 : d2.screenfull) == null ? void 0 : v.js, i2 = ref(false), r3 = (y) => {
    if (!a3) {
      g2.emit(o2, "errorCatcher", {
        name: "fullscreen",
        message: "fullscreen is undefined"
      });
      return;
    }
    a3.isEnabled ? (i2.value = true, (y === void 0 ? !a3.isFullscreen : y) ? a3.request() : a3.exit()) : console.error("browser does not support screenfull!");
  }, c3 = () => {
    a3 && a3.isEnabled && a3.on("change", () => {
      (i2.value || e4.setting.fullscreen) && (i2.value = false, e4.updateSetting("fullscreen"));
    });
  }, m4 = () => {
    a3 = window.screenfull, c3();
  };
  return onMounted(() => {
    if (c3(), !a3) {
      const y = document.createElement("script");
      y.src = l2 || h, y.onload = m4, y.id = `${a}-screenfull`, h2(y, "screenfull");
    }
  }), onMounted(() => {
    g2.on(o2, {
      name: Ce,
...
var qt = defineComponent({
  ...
  setup(e4) {
    ...
    return () => createVNode("div", {
    ...
    }, [new Array(e4.tableShape[1]).fill("").map((a3, l2) => createVNode("div", {
      class: `${a}-table-shape-row`,
      key: `table-shape-row-${l2}`
    }, [new Array(e4.tableShape[0]).fill("").map((i2, r3) => createVNode("div", {
      class: `${a}-table-shape-col`,
      key: `table-shape-col-${r3}`,
      onMouseenter: () => {
        o2.x = l2, o2.y = r3;
      },
      onClick: () => {
      ...
      class: [`${a}-table-shape-col-default`, l2 <= o2.x && r3 <= o2.y && `${a}-table-shape-col-include`]
    }, null)]))]))]);
  }
});
var Ut = qt;
...
var Kt = defineComponent({
  props: Gt,
  setup(e4) {
    const o2 = inject("usedLanguageText"), a3 = inject("editorId"), l2 = computed(() => {
      var r3, c3;
      switch (e4.type) {
        case "link":
          return (r3 = o2.value.linkModalTips) == null ? void 0 : r3.linkTitle;
        case "image":
          return (c3 = o2.value.linkModalTips) == null ? void 0 : c3.imageTitle;
        default:
          return "";
      }
    }), i2 = reactive({
    ...
    return watch(() => e4.visible, (r3) => {
      ...
      default: () => {
        ...
        return [createVNode("div", {
          ...
          class: `${a}-label`,
          for: `link-desc-${a3}`
        }, [(r3 = o2.value.linkModalTips) == null ? void 0 : r3.descLabel]), createVNode("input", {
          placeholder: (c3 = o2.value.linkModalTips) == null ? void 0 : c3.descLabelPlaceHolder,
          class: `${a}-input`,
          id: `link-desc-${a3}`,
          type: "text",
          value: i2.desc,
          onChange: (d2) => {
            i2.desc = d2.target.value;
          },
          autocomplete: "off"
        }, null)]), createVNode("div", {
          class: `${a}-form-item`
          ...
          class: `${a}-label`,
          for: `link-url-${a3}`
        }, [(m4 = o2.value.linkModalTips) == null ? void 0 : m4.urlLabel]), createVNode("input", {
          placeholder: (f3 = o2.value.linkModalTips) == null ? void 0 : f3.urlLabelPlaceHolder,
          class: `${a}-input`,
          id: `link-url-${a3}`,
          type: "text",
          value: i2.url,
          onChange: (d2) => {
            i2.url = d2.target.value;
          },
          autocomplete: "off"
        }, null)]), createVNode("div", {
          class: `${a}-form-item`
          ...
          type: "button",
          onClick: () => {
            e4.onOk(i2), i2.desc = "", i2.url = "";
          }
        }, [(u3 = o2.value.linkModalTips) == null ? void 0 : u3.buttonOK])])];
      }
    });
  }
});
...
var _t = defineComponent({
  ...
  setup(e4) {
    var d2, v, y;
    const o2 = inject("usedLanguageText"), a3 = inject("editorId");
    let l2 = (y = (v = (d2 = l) == null ? void 0 : d2.editorExtensions) == null ? void 0 : v.cropper) == null ? void 0 : y.instance;
    const i2 = ref(), r3 = ref(), c3 = ref(), m4 = reactive({
      cropperInited: false,
      imgSelected: false,
      imgSrc: "",
      // 是否全屏
    ...
    let f3 = null;
    watch(() => e4.visible, () => {
      e4.visible && !m4.cropperInited && (l2 = l2 || window.Cropper, i2.value.onchange = () => {
        if (!l2) {
        ...
        const b4 = i2.value.files || [];
        if (m4.imgSelected = true, (b4 == null ? void 0 : b4.length) > 0) {
          const p3 = new FileReader();
          p3.onload = (g4) => {
            m4.imgSrc = g4.target.result, nextTick(() => {
              f3 = new l2(r3.value, {
                viewMode: 2,
          ...
          }, p3.readAsDataURL(b4[0]);
        }
      });
    }), watch(() => [m4.imgSelected], () => {
      c3.value.style = "";
    }), watch(() => m4.isFullscreen, () => {
      nextTick(() => {
        f3 == null || f3.destroy(), c3.value.style = "", r3.value && (f3 = new l2(r3.value, {
          viewMode: 2,
          preview: `.${a}-clip-preview-target`
          // aspectRatio: 16 / 9,
        }));
    ...
    const u3 = () => {
      f3.clear(), f3.destroy(), f3 = null, i2.value.value = "", m4.imgSelected = false;
    };
    return () => {
      var b4;
      return createVNode(B2, {
        class: `${a}-modal-clip`,
        title: (b4 = o2.value.clipModalTips) == null ? void 0 : b4.title,
        visible: e4.visible,
        onClose: e4.onCancel,
        showAdjust: true,
        isFullscreen: m4.isFullscreen,
        onAdjust: (p3) => {
          m4.isFullscreen = p3;
        },
        width: "668px",
        ...
        default: () => {
          ...
          return [createVNode("div", {
            ...
            class: `${a}-clip-main`
          }, [m4.imgSelected ? createVNode("div", {
            ...
            onClick: () => {
              if (f3) {
                const k2 = f3.getCroppedCanvas();
                g2.emit(a3, "uploadImage", [f2(k2.toDataURL("image/png"))], e4.onOk), u3();
              }
            }
          }, [((p3 = o2.value.clipModalTips) == null ? void 0 : p3.buttonUpload) || ((g4 = o2.value.linkModalTips) == null ? void 0 : g4.buttonOK)])]), createVNode("input", {
            ref: i2,
            accept: "image/*",
            type: "file",
            multiple: false,
...
var zt = defineComponent({
  props: Wt,
  setup(e4) {
    return () => createVNode(Fragment, null, [createVNode(Kt, {
      type: e4.type,
...
var Yt = defineComponent({
  ...
  props: Rt,
  setup(e4) {
    const o2 = inject("editorId"), a3 = inject("usedLanguageText"), {
      fullscreenHandler: l2
    } = Pt(e4), i2 = `${o2}-toolbar-wrapper`, r3 = reactive({
      title: false,
      catalog: false,
      // 图片上传下拉
      image: false,
    ...
    onMounted(() => {
      g2.on(o2, {
        name: "openModals",
        callback(b4) {
          m4.type = b4, m4.linkVisible = true;
        }
      });
    });
    const u3 = computed(() => {
      const b4 = e4.toolbars.filter((x2) => !e4.toolbarsExclude.includes(x2)), p3 = b4.indexOf("="), g4 = p3 === -1 ? b4 : b4.slice(0, p3 + 1), k2 = p3 === -1 ? [] : b4.slice(p3, Number.MAX_SAFE_INTEGER);
      return [g4, k2];
    }), d2 = ref(), v = () => {
      g2.emit(o2, "uploadImage", Array.from(d2.value.files || [])), d2.value.value = "";
    };
    onMounted(() => {
      d2.value.addEventListener("change", v);
    });
    const y = (b4) => {
      var p3, g4, k2, x2, T2, w, M4, C2, A2, R3, L4, D2, V2, I3, E, K2, N2, ae, J, j2, q2, X, _, H, B3, Q2, ne2, he, be2, ve, pe, ke2, Ce2, $e, ye2, xe2, we, Te2, Se2, Ae2, Me2, Le2, De2;
      if (g.includes(b4))
        switch (b4) {
          case "-":
            return createVNode(Vt, null, null);
          case "bold":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (p3 = a3.value.toolbarTips) == null ? void 0 : p3.bold,
              onClick: () => {
                c3("bold");
              }
            }, [createVNode("svg", {
          ...
          case "underline":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (g4 = a3.value.toolbarTips) == null ? void 0 : g4.underline,
              onClick: () => {
                c3("underline");
              }
            }, [createVNode("svg", {
          ...
          case "italic":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (k2 = a3.value.toolbarTips) == null ? void 0 : k2.italic,
              onClick: () => {
                c3("italic");
              }
            }, [createVNode("svg", {
          ...
          case "strikeThrough":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (x2 = a3.value.toolbarTips) == null ? void 0 : x2.strikeThrough,
              onClick: () => {
                c3("strikeThrough");
              }
            }, [createVNode("svg", {
          ...
          case "title":
            return createVNode(I, {
              ...
              }, [(T2 = a3.value.titleItem) == null ? void 0 : T2.h1]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("h2");
                }
              }, [(w = a3.value.titleItem) == null ? void 0 : w.h2]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("h3");
                }
              }, [(M4 = a3.value.titleItem) == null ? void 0 : M4.h3]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("h4");
                }
              }, [(C2 = a3.value.titleItem) == null ? void 0 : C2.h4]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("h5");
                }
              }, [(A2 = a3.value.titleItem) == null ? void 0 : A2.h5]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("h6");
                }
              }, [(R3 = a3.value.titleItem) == null ? void 0 : R3.h6])])
            }, {
              default: () => {
                var $;
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = a3.value.toolbarTips) == null ? void 0 : $.title
                }, [createVNode("svg", {
                  class: `${a}-icon`,
                  "aria-hidden": "true"
                }, [createVNode("use", {
          ...
          case "sub":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (L4 = a3.value.toolbarTips) == null ? void 0 : L4.sub,
              onClick: () => {
                c3("sub");
              }
            }, [createVNode("svg", {
          ...
          case "sup":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (D2 = a3.value.toolbarTips) == null ? void 0 : D2.sup,
              onClick: () => {
                c3("sup");
              }
            }, [createVNode("svg", {
          ...
          case "quote":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (V2 = a3.value.toolbarTips) == null ? void 0 : V2.quote,
              onClick: () => {
                c3("quote");
              }
            }, [createVNode("svg", {
          ...
          case "unorderedList":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (I3 = a3.value.toolbarTips) == null ? void 0 : I3.unorderedList,
              onClick: () => {
                c3("unorderedList");
              }
            }, [createVNode("svg", {
          ...
          case "orderedList":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (E = a3.value.toolbarTips) == null ? void 0 : E.orderedList,
              onClick: () => {
                c3("orderedList");
              }
            }, [createVNode("svg", {
          ...
          case "task":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (K2 = a3.value.toolbarTips) == null ? void 0 : K2.task,
              onClick: () => {
                c3("task");
              }
            }, [createVNode("svg", {
          ...
          case "codeRow":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (N2 = a3.value.toolbarTips) == null ? void 0 : N2.codeRow,
              onClick: () => {
                c3("codeRow");
              }
            }, [createVNode("svg", {
          ...
          case "code":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (ae = a3.value.toolbarTips) == null ? void 0 : ae.code,
              onClick: () => {
                c3("code");
              }
            }, [createVNode("svg", {
          ...
          case "link":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (J = a3.value.toolbarTips) == null ? void 0 : J.link,
              onClick: () => {
                m4.type = "link", m4.linkVisible = true;
              }
            }, [createVNode("svg", {
              class: `${a}-icon`,
              "aria-hidden": "true"
          ...
          case "image":
            return e4.noUploadImg ? createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (j2 = a3.value.toolbarTips) == null ? void 0 : j2.image,
              onClick: () => {
                m4.type = "image", m4.linkVisible = true;
              }
            }, [createVNode("svg", {
              class: `${a}-icon`,
              "aria-hidden": "true"
              ...
              }, [(q2 = a3.value.imgTitleItem) == null ? void 0 : q2.link]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  d2.value.click();
                }
              }, [(X = a3.value.imgTitleItem) == null ? void 0 : X.upload]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  m4.clipVisible = true;
                }
              }, [(_ = a3.value.imgTitleItem) == null ? void 0 : _.clip2upload])])
            }, {
              default: () => {
                var $;
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = a3.value.toolbarTips) == null ? void 0 : $.image
                }, [createVNode("svg", {
                  class: `${a}-icon`,
                  "aria-hidden": "true"
                }, [createVNode("use", {
          ...
          case "table":
            return createVNode(I, {
              ...
              default: () => {
                ...
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = a3.value.toolbarTips) == null ? void 0 : $.table
                }, [createVNode("svg", {
                  class: `${a}-icon`,
                  "aria-hidden": "true"
                }, [createVNode("use", {
          ...
          case "revoke":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (H = a3.value.toolbarTips) == null ? void 0 : H.revoke,
              onClick: () => {
                g2.emit(o2, "ctrlZ");
              }
            }, [createVNode("svg", {
          ...
          case "next":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (B3 = a3.value.toolbarTips) == null ? void 0 : B3.next,
              onClick: () => {
                g2.emit(o2, "ctrlShiftZ");
              }
            }, [createVNode("svg", {
              class: `${a}-icon`,
              "aria-hidden": "true"
          ...
          case "save":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (Q2 = a3.value.toolbarTips) == null ? void 0 : Q2.save,
              onClick: () => {
                g2.emit(o2, Q);
              }
            }, [createVNode("svg", {
          ...
          case "prettier":
            return e4.noPrettier ? "" : createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (ne2 = a3.value.toolbarTips) == null ? void 0 : ne2.prettier,
              onClick: () => {
                c3("prettier");
              }
            }, [createVNode("svg", {
          ...
          case "pageFullscreen":
            return !e4.setting.fullscreen && createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (he = a3.value.toolbarTips) == null ? void 0 : he.pageFullscreen,
              onClick: () => {
          ...
          case "fullscreen":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (be2 = a3.value.toolbarTips) == null ? void 0 : be2.fullscreen,
              onClick: () => {
                l2();
              }
            }, [createVNode("svg", {
          ...
          case "preview":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (ve = a3.value.toolbarTips) == null ? void 0 : ve.preview,
              onClick: () => {
          ...
          case "htmlPreview":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (pe = a3.value.toolbarTips) == null ? void 0 : pe.htmlPreview,
              onClick: () => {
          ...
          case "catalog":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (ke2 = a3.value.toolbarTips) == null ? void 0 : ke2.catalog,
              onClick: () => {
                g2.emit(o2, Y);
              },
              key: "bar-catalog"
          ...
          case "github":
            return createVNode("div", {
              class: `${a}-toolbar-item`,
              title: (Ce2 = a3.value.toolbarTips) == null ? void 0 : Ce2.github,
          ...
          case "mermaid":
            return createVNode(I, {
              ...
              }, [($e = a3.value.mermaid) == null ? void 0 : $e.flow]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("sequence");
                }
              }, [(ye2 = a3.value.mermaid) == null ? void 0 : ye2.sequence]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("gantt");
                }
              }, [(xe2 = a3.value.mermaid) == null ? void 0 : xe2.gantt]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("class");
                }
              }, [(we = a3.value.mermaid) == null ? void 0 : we.class]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("state");
                }
              }, [(Te2 = a3.value.mermaid) == null ? void 0 : Te2.state]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("pie");
                }
              }, [(Se2 = a3.value.mermaid) == null ? void 0 : Se2.pie]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("relationship");
                }
              }, [(Ae2 = a3.value.mermaid) == null ? void 0 : Ae2.relationship]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("journey");
                }
              }, [(Me2 = a3.value.mermaid) == null ? void 0 : Me2.journey])]),
              key: "bar-mermaid"
            }, {
              default: () => {
                var $;
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = a3.value.toolbarTips) == null ? void 0 : $.mermaid
                }, [createVNode("svg", {
                  class: `${a}-icon`,
                  "aria-hidden": "true"
                }, [createVNode("use", {
          ...
          case "katex":
            return createVNode(I, {
              ...
              }, [(Le2 = a3.value.katex) == null ? void 0 : Le2.inline]), createVNode("li", {
                class: `${a}-menu-item`,
                onClick: () => {
                  c3("katexBlock");
                }
              }, [(De2 = a3.value.katex) == null ? void 0 : De2.block])]),
              key: "bar-katex"
            }, {
              default: () => {
                var $;
                return [createVNode("div", {
                  class: `${a}-toolbar-item`,
                  title: ($ = a3.value.toolbarTips) == null ? void 0 : $.katex
                }, [createVNode("svg", {
                  class: `${a}-icon`,
                  "aria-hidden": "true"
                }, [createVNode("use", {
        ...
        return e4.defToolbars instanceof Array ? e4.defToolbars[b4] || "" : e4.defToolbars && e4.defToolbars.children instanceof Array && e4.defToolbars.children[b4] || "";
    };
    return () => {
      const b4 = u3.value[0].map((g4) => y(g4)), p3 = u3.value[1].map((g4) => y(g4));
      return createVNode(Fragment, null, [e4.toolbars.length > 0 && createVNode("div", {
        ...
        linkVisible: m4.linkVisible,
        clipVisible: m4.clipVisible,
        type: m4.type,
        onCancel: () => {
          m4.linkVisible = false, m4.clipVisible = false;
        },
        onOk: (g4) => {
          g4 && c3(m4.type, {
            desc: g4.desc,
...
var Zt = (e4, o2) => {
  const a3 = x(() => {
    e4.removeEventListener("scroll", l2), e4.addEventListener("scroll", l2), o2.removeEventListener("scroll", l2), o2.addEventListener("scroll", l2);
  }, 50), l2 = (i2) => {
    const r3 = e4.clientHeight, c3 = o2.clientHeight, m4 = e4.scrollHeight, f3 = o2.scrollHeight, u3 = (m4 - r3) / (f3 - c3);
    i2.target === e4 ? (o2.removeEventListener("scroll", l2), o2.scrollTo({
      top: e4.scrollTop / u3
      // behavior: 'smooth'
    }), a3()) : (e4.removeEventListener("scroll", l2), e4.scrollTo({
      top: o2.scrollTop * u3
      // behavior: 'smooth'
    }), a3());
  };
  return [
    ...
    () => {
      e4.removeEventListener("scroll", l2), o2.removeEventListener("scroll", l2);
    }
  ];
};
var Jt = (e4, o2, a3) => {
  const { view: l2 } = a3, i2 = (v) => l2.lineBlockAt(l2.state.doc.line(v).from).top, r3 = (v) => l2.lineBlockAt(l2.state.doc.line(v).from).height;
  let c3 = [];
  const m4 = () => {
    c3 = [];
    const v = Array.from(o2.querySelectorAll("[data-line]")).map(
      (g4) => Number(g4.dataset.line) + 1
    ), { lines: y } = l2.state.doc;
    let b4 = 1, p3 = v.shift() ?? y;
    for (let g4 = 1; g4 <= y; g4++)
      g4 === p3 && (b4 = g4, p3 = v.shift() || y + 1), c3.push({
        start: b4,
        end: p3 - 1
      });
  };
  let f3 = 0, u3 = 0;
  const d2 = L((v) => {
    var p3, g4, k2, x2, T2, w, M4;
    if (!((p3 = o2.firstElementChild) != null && p3.firstElementChild))
      return;
    const y = l2.lineBlockAtHeight(l2.scrollDOM.scrollTop), { number: b4 } = l2.state.doc.lineAt(y.from);
    if (!(b4 > c3.length) && !(l2.state.doc.lines < c3[c3.length - 1].end))
      if (v.target === e4) {
        if (u3 !== 0)
          return;
        f3++;
        const C2 = c3[b4 - 1], A2 = i2(C2.end) + r3(C2.end);
        let R3 = 0;
        const L4 = i2(C2.start), D2 = o2.querySelector(`[data-line="${C2.start - 1}"]`) || ((g4 = o2.firstElementChild) == null ? void 0 : g4.firstElementChild), V2 = o2.querySelector(`[data-line="${C2.end}"]`) || ((k2 = o2.lastElementChild) == null ? void 0 : k2.lastElementChild);
        let I3 = 0, E = 0;
        L4 === 0 ? (R3 = (l2.scrollDOM.scrollTop - L4) / (A2 - L4), I3 = V2.offsetTop) : A2 > l2.scrollDOM.scrollHeight - l2.scrollDOM.clientHeight ? (R3 = (l2.scrollDOM.scrollTop - L4) / (l2.scrollDOM.scrollHeight - l2.scrollDOM.clientHeight - L4), E = D2.offsetTop, I3 = o2.scrollHeight - o2.clientHeight - E + 10) : (R3 = (l2.scrollDOM.scrollTop - L4) / (A2 - L4), E = D2.offsetTop, I3 = V2.offsetTop - E);
        const K2 = E - 10 + I3 * R3;
        S(o2, K2, () => {
          f3--;
        });
        ...
        ), A2 = o2.scrollTop, R3 = o2.scrollHeight;
        let L4 = C2.length === 0 ? 1 : Math.ceil(
          Number(C2[C2.length - 1].dataset.line) * (A2 / R3)
        ), D2 = (x2 = o2.firstElementChild) == null ? void 0 : x2.firstElementChild;
        for (let H = L4; H >= 0; H--) {
          const B3 = o2.querySelector(`[data-line="${H}"]`);
          if (B3 && B3.offsetTop <= A2) {
            D2 = B3, L4 = H;
            break;
          }
        }
        let V2 = (T2 = o2.firstElementChild) == null ? void 0 : T2.firstElementChild, I3 = (w = o2.firstElementChild) == null ? void 0 : w.lastElementChild;
        for (; C2.length > 0; ) {
          const H = C2.indexOf(D2);
          if (H + 1 >= C2.length)
            break;
          const B3 = C2[H + 1];
          if (H === -1) {
        ...
        const E = V2.offsetTop, K2 = I3.offsetTop;
        let N2 = 0;
        const { start: ae, end: J } = c3[Number(V2.dataset.line || 0)], j2 = i2(ae);
        let q2 = i2(J);
        const X = r3(J);
        let _ = 0;
        V2 === ((M4 = o2.firstElementChild) == null ? void 0 : M4.firstElementChild) ? (N2 = Math.max(A2 / K2, 0), _ = q2 + X - j2) : q2 > l2.scrollDOM.scrollHeight - l2.scrollDOM.clientHeight ? (N2 = Math.max(
          (A2 - E) / (o2.scrollHeight - E - o2.clientHeight),
          0
        ), q2 = i2(l2.state.doc.lines) + r3(l2.state.doc.lines), _ = 8 + q2 - j2 - e4.clientHeight) : (N2 = Math.max(
          (A2 - E) / (K2 - E),
          0
        ), _ = q2 + X - j2), S(e4, j2 + _ * N2, () => {
          u3--;
        });
      }
  }, 10);
  return [
    () => {
      m4(), e4.addEventListener("scroll", d2), o2.addEventListener("scroll", d2), e4.dispatchEvent(new Event("scroll"));
    },
    () => {
      c3 = [], e4.removeEventListener("scroll", d2), o2.removeEventListener("scroll", d2);
    }
  ];
};
var Xt = (e4, o2, a3) => {
  const l2 = inject("editorId");
  let i2 = () => {
  }, r3 = () => {
  };
  const c3 = () => {
    i2();
    const m4 = document.querySelector(".cm-scroller"), f3 = document.querySelector(
      `[id="${l2}-preview-wrapper"][data-show="true"]`
    ), u3 = document.querySelector(
      `[id="${l2}-html-wrapper"][data-show="true"]`
    );
    (f3 || u3) && ([r3, i2] = (f3 ? Jt : Zt)(
      m4,
      f3 || u3,
      a3.value
    )), e4.scrollAuto && r3();
...
var el = (e4, o2, a3) => {
  var d2, v, y, b4, p3, g4;
  let l2 = "", i2 = 0, r3 = 0, c3 = true, m4 = false;
  const f3 = o2.getSelectedText(), u3 = (d2 = l.editorConfig) == null ? void 0 : d2.mermaidTemplate;
  if (/^h[1-6]{1}$/.test(e4)) {
    const k2 = e4.replace(/^h(\d)/, (x2, T2) => new Array(Number(T2)).fill("#", 0, T2).join(""));
    l2 = `${k2} ${f3}`, i2 = k2.length + 1;
  } else if (e4 === "prettier") {
    const k2 = window.prettier || ((y = (v = l.editorExtensions) == null ? void 0 : v.prettier) == null ? void 0 : y.prettierInstance), x2 = [
      ((b4 = window.prettierPlugins) == null ? void 0 : b4.markdown) || ((g4 = (p3 = l.editorExtensions) == null ? void 0 : p3.prettier) == null ? void 0 : g4.parserMarkdownInstance)
    ];
    !k2 || x2[0] === void 0 ? (g2.emit(a3.editorId, "errorCatcher", {
      name: "prettier",
      message: "prettier is undefined"
    }), l2 = o2.getValue()) : l2 = k2.format(o2.getValue(), {
      parser: "markdown",
      plugins: x2
    }), c3 = false, m4 = true;
  } else
    switch (e4) {
      ...
      case "sub": {
        l2 = `<sub>${f3}</sub>`, i2 = 5, r3 = -6;
        break;
      }
      case "sup": {
        l2 = `<sup>${f3}</sup>`, i2 = 5, r3 = -6;
        break;
      }
      case "codeRow": {
        l2 = "`" + f3 + "`", i2 = 1, r3 = -1;
      ...
      case "code": {
        const k2 = a3.text || f3 || "", x2 = a3.mode || "language";
        l2 = `\`\`\`${x2}
${k2}
\`\`\`
`, i2 = 3, r3 = 3 + x2.length - l2.length;
        break;
      }
      case "table": {
        l2 = "|";
        const { selectedShape: k2 = { x: 1, y: 1 } } = a3, { x: x2, y: T2 } = k2;
        for (let w = 0; w <= T2; w++)
          l2 += " col |";
        l2 += `
|`;
...
|`;
      ...
      case "link": {
        const { desc: k2, url: x2 } = a3;
        l2 = `[${k2}](${x2})`, c3 = false;
        break;
      }
      case "image": {
        const { desc: k2, url: x2, urls: T2 } = a3;
        T2 instanceof Array ? l2 = T2.reduce((w, M4) => w + `![${k2}](${M4})
`, "") : l2 = `![${k2}](${x2})
`, c3 = false;
        break;
      }
      case "flow": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.flow) || `flowchart TD 
  Start --> Stop`}
\`\`\`
`, i2 = 3, r3 = 10 - l2.length;
        break;
      }
      case "sequence": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.sequence) || `sequenceDiagram
  A->>B: hello!
  B-->>A: hi!
  A-)B: bye!`}
\`\`\`
...
`, i2 = 3, r3 = 10 - l2.length;
      ...
      case "class": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.class) || `classDiagram
  class Animal
  Vehicle <|-- Car`}
\`\`\`
`, i2 = 3, r3 = 10 - l2.length;
      ...
      case "state": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.state) || `stateDiagram-v2
  s1 --> s2`}
\`\`\`
`, i2 = 3, r3 = 10 - l2.length;
        break;
      ...
      case "pie": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.pie) || `pie title Pets adopted by volunteers
  "Dogs" : 386
  "Cats" : 85
  "Rats" : 15`}
\`\`\`
`, i2 = 3, r3 = 10 - l2.length;
      ...
      case "relationship": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.relationship) || `erDiagram
...
`, i2 = 3, r3 = 10 - l2.length;
      ...
      case "journey": {
        l2 = `\`\`\`mermaid
${(u3 == null ? void 0 : u3.journey) || `journey
...
`, i2 = 3, r3 = -4;
      ...
      case "universal": {
        const { generate: k2 } = a3, x2 = k2(f3);
        l2 = x2.targetValue, c3 = x2.select, i2 = x2.deviationStart, r3 = x2.deviationEnd;
      }
    }
  return {
    text: l2,
...
var il = "#21252b";
var sl = "#2c313a";
var Oe2 = "var(--md-bk-color)";
var ce = "var(--md-bk-color)";
var cl = "#ceedfa33";
var Ve2 = "#528bff";
var dl = EditorView.theme(
  {
    "&": {
      color: le,
      backgroundColor: Oe2
    ...
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: Ve2 },
...
var ul = HighlightStyle.define([
  { tag: tags.keyword, color: rl },
  { tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: Ie2 },
  { tag: [tags.function(tags.variableName), tags.labelName], color: al },
  { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: Fe2 },
  { tag: [tags.definition(tags.name), tags.separator], color: le },
  {
    tag: [
      tags.typeName,
      tags.className,
  ...
  { tag: [tags.meta, tags.comment], color: Be2 },
  { tag: tags.strong, fontWeight: "bold" },
  { tag: tags.emphasis, fontStyle: "italic" },
  { tag: tags.strikethrough, textDecoration: "line-through" },
  { tag: tags.link, color: Be2, textDecoration: "underline" },
  { tag: tags.heading, fontWeight: "bold", color: Ie2 },
  { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: Fe2 },
  { tag: [tags.processingInstruction, tags.string, tags.inserted], color: nl },
  { tag: tags.invalid, color: ol }
]);
var ml = [
  dl,
...
var kl = "#21252b";
var Cl = "#ceedfa33";
var qe2 = "var(--md-bk-color)";
var de = "var(--md-bk-color)";
var $l = "#bad5fa";
var Ue2 = "#3f4a54";
var yl = EditorView.theme(
  {
    "&": {
      color: oe,
      backgroundColor: qe2
    ...
    ".cm-cursor, .cm-dropCursor": { borderLeftColor: Ue2 },
...
var xl = HighlightStyle.define([
  { tag: tags.keyword, color: pl },
  { tag: [tags.name, tags.deleted, tags.character, tags.propertyName, tags.macroName], color: Re2 },
  { tag: [tags.function(tags.variableName), tags.labelName], color: bl },
  { tag: [tags.color, tags.constant(tags.name), tags.standard(tags.name)], color: Ne2 },
  { tag: [tags.definition(tags.name), tags.separator], color: oe },
  {
    tag: [
      tags.typeName,
      tags.className,
  ...
  { tag: [tags.meta, tags.comment], color: Pe2 },
  { tag: tags.strong, fontWeight: "bold" },
  { tag: tags.emphasis, fontStyle: "italic" },
  { tag: tags.strikethrough, textDecoration: "line-through" },
  { tag: tags.link, color: Pe2, textDecoration: "underline" },
  { tag: tags.heading, fontWeight: "bold", color: Re2 },
  { tag: [tags.atom, tags.bool, tags.special(tags.variableName)], color: Ne2 },
  { tag: [tags.processingInstruction, tags.string, tags.inserted], color: vl },
  { tag: tags.invalid, color: hl }
]);
var wl = [
  yl,
  syntaxHighlighting(xl)
];
var ie = (e4, o2, a3, l2, i2) => (r3, c3, m4, f3) => {
  const u3 = `${e4}${o2}`.slice(f3 - m4);
  r3.dispatch(r3.state.replaceSelection(`${u3}${a3}${l2}`));
  const d2 = m4 + c3.label.length + (i2 === "title" ? a3.length : 0);
  r3.dispatch({
    selection: EditorSelection.create(
      [
        EditorSelection.range(
          m4 + c3.label.length + (i2 === "title" ? 1 : -o2.length),
          d2
        ),
        EditorSelection.cursor(d2)
      ],
      1
    )
  }), r3.focus();
};
var Ge2 = (e4) => (o2, a3, l2, i2) => {
  const r3 = e4.slice(i2 - l2);
  o2.dispatch(o2.state.replaceSelection(`${r3} `));
};
var Tl = (e4) => {
  const o2 = (a3) => {
    const l2 = a3.matchBefore(
      /^#+|^-\s*\[*\s*\]*|`+|\[|!\[*|^\|\s?\|?|^\$\$?|!+\s*\w*/
    );
    return l2 === null || l2.from == l2.to && a3.explicit ? null : {
      from: l2.from,
      options: [
        // 标题
        ...["h1", "h2", "h3", "h4", "h5", "h6"].map((i2, r3) => {
          const c3 = new Array(r3 + 1).fill("#").join("");
          return {
            label: c3,
            type: "text",
            apply: Ge2(c3)
        ...
        // 任务列表
        ...["unchecked", "checked"].map((i2) => {
          const r3 = i2 === "checked" ? "- [x]" : "- [ ]";
          return {
            label: r3,
            type: "text",
            apply: Ge2(r3)
...
var Y2 = (e4) => {
  ...
  return (l2) => (o2.get(e4.state) ? e4.dispatch({ effects: o2.reconfigure(l2) }) : e4.dispatch({
    effects: StateEffect.appendConfig.of(o2.of(l2))
  }), true);
};
var Al = class {
  constructor(o2) {
    ...
    this.view = o2, this.toggleTabSize = Y2(this.view), this.togglePlaceholder = Y2(this.view), this.setExtensions = Y2(this.view), this.toggleDisabled = Y2(this.view), this.toggleReadOnly = Y2(this.view), this.toggleMaxlength = Y2(this.view);
  }
  getValue() {
   ...
   * @param to 插入结束位置
   */
  setValue(o2, a3 = 0, l2 = this.view.state.doc.length) {
    this.view.dispatch({
      changes: {
        from: a3,
        to: l2,
   ...
   */
  getSelectedText() {
    const { from: o2, to: a3 } = this.view.state.selection.main;
    return this.view.state.sliceDoc(o2, a3);
  }
  /**
   * 使用新的内容替换选中的内容
   *
  ...
  replaceSelectedText(o2, a3 = {
    ...
    const { from: l2 } = this.view.state.selection.main;
    if (this.view.dispatch(this.view.state.replaceSelection(o2)), a3.select) {
      const i2 = l2 + o2.length + a3.deviationEnd;
      this.view.dispatch({
        selection: EditorSelection.create(
          [
            EditorSelection.range(l2 + a3.deviationStart, i2),
            EditorSelection.cursor(i2)
          ],
          1
        )
      });
  ...
  focus(o2) {
    ...
    switch (o2) {
      case "start":
        break;
      case "end": {
        a3 = l2 = i2 = this.getValue().length;
        break;
      }
      default:
        a3 = o2.rangeAnchor || o2.cursorPos, l2 = o2.rangeHead || o2.cursorPos, i2 = o2.cursorPos;
    }
    this.view.dispatch({
      scrollIntoView: true,
      selection: EditorSelection.create(
        [EditorSelection.range(a3, l2), EditorSelection.cursor(i2)],
        1
      )
    });
  }
  ...
  setMaxLength(o2) {
    this.toggleMaxlength([
      EditorState.changeFilter.of((a3) => a3.newDoc.length <= o2)
    ]);
  }
};
var Ml = (e4) => {
  ...
  return (l2) => {
    if (l2.clipboardData) {
      if (l2.clipboardData.files.length > 0) {
        const { files: i2 } = l2.clipboardData;
        g2.emit(
          o2,
          "uploadImage",
          Array.from(i2).filter((r3) => /image\/.*/.test(r3.type))
        ), l2.preventDefault();
      }
      if (e4.autoDetectCode && l2.clipboardData.types.includes("vscode-editor-data")) {
        const i2 = JSON.parse(l2.clipboardData.getData("vscode-editor-data"));
        g2.emit(o2, "replace", "code", {
          mode: i2.mode,
          text: l2.clipboardData.getData("text/plain")
        }), l2.preventDefault();
      }
    }
  };
...
var Hl = (e4, o2) => [
  ...
  },
  {
    key: "Ctrl-s",
    mac: "Cmd-s",
    run: (M4) => (g2.emit(e4, Q, M4.state.doc.toString()), true),
  ...
  },
  {
    ...
    any(M4, C2) {
      return (C2.ctrlKey || C2.metaKey) && C2.altKey && C2.code === "KeyC" ? (g2.emit(e4, "replace", "codeRow"), true) : false;
    }
  },
  {
    key: "Ctrl-l",
  ...
  },
  {
    key: "Ctrl-f",
    mac: "Cmd-f",
    shift: () => o2.noPrettier ? false : (g2.emit(e4, "replace", "prettier"), true)
  },
  {
    any: (M4, C2) => (C2.ctrlKey || C2.metaKey) && C2.altKey && C2.shiftKey && C2.code === "KeyT" ? (g2.emit(e4, "replace", "table"), true) : false
  }
];
var Il = Hl;
var Bl = (e4) => {
  const o2 = inject("tabWidth"), a3 = inject("editorId"), l2 = inject("theme"), i2 = ref(), r3 = shallowRef(), c3 = Il(a3, e4), m4 = Ll(e4), f3 = [
    keymap.of([...c3, indentWithTab]),
    minimalSetup,
    markdown({ codeLanguages: languages }),
    // 横向换行
    EditorView.lineWrapping,
    EditorView.updateListener.of((d2) => {
      d2.docChanged && e4.onChange(d2.state.doc.toString());
    }),
    EditorView.domEventHandlers({
      paste: m4,
      blur: e4.onBlur,
    ...
    const d2 = [
      ...f3,
      l2.value === "light" ? wl : ml,
      Sl(e4.completions)
    ];
    return l.codeMirrorExtensions(l2.value, d2, [
      ...c3
    ]);
  };
  return onMounted(() => {
    const d2 = new EditorView({
      doc: e4.value,
      parent: i2.value
    }), v = new Al(d2);
    r3.value = v, setTimeout(() => {
      v.setTabSize(o2), v.setDisabled(e4.disabled), v.setReadOnly(e4.readonly), v.setExtensions(u3()), e4.placeholder && v.setPlaceholder(e4.placeholder), typeof e4.maxlength == "number" && v.setMaxLength(e4.maxlength), e4.autofocus && d2.focus();
    }, 0), g2.on(a3, {
      name: "ctrlZ",
      callback() {
        undo(d2);
      ...
      callback(y, b4 = {}) {
        var k2;
        const { text: p3, options: g4 } = el(y, r3.value, b4);
        (k2 = r3.value) == null || k2.replaceSelectedText(p3, g4);
      }
    });
  }), watch(
    [l2, toRef(e4, "completions")],
    () => {
      var d2;
      (d2 = r3.value) == null || d2.setExtensions(u3());
    },
    {
      deep: true
    }
    ...
    () => {
      var d2, v;
      ((d2 = r3.value) == null ? void 0 : d2.getValue()) !== e4.value && ((v = r3.value) == null || v.setValue(e4.value));
    }
  ), watch(
    () => e4.placeholder,
    () => {
      var d2;
      (d2 = r3.value) == null || d2.setPlaceholder(e4.placeholder);
    }
  ), watch(
    () => e4.disabled,
    () => {
      var d2;
      (d2 = r3.value) == null || d2.setDisabled(e4.disabled);
    }
  ), watch(
    () => e4.readonly,
    () => {
      var d2;
      (d2 = r3.value) == null || d2.setDisabled(e4.readonly);
    }
  ), watch(
    () => e4.maxlength,
    () => {
      var d2;
      e4.maxlength && ((d2 = r3.value) == null || d2.setMaxLength(e4.maxlength));
    }
  ), El(r3), {
    inputWrapperRef: i2,
    codeMirrorUt: r3
...
var Vl = defineComponent({
  ...
  props: Ol,
  setup(e4) {
    const o2 = inject("editorId"), a3 = ref(""), {
      inputWrapperRef: l2,
      codeMirrorUt: i2
    } = Fl(e4);
    return Qt(e4, a3, i2), () => createVNode("div", {
      class: `${a}-content`
    }, [createVNode("div", {
      ...
      setting: e4.setting,
      onHtmlChanged: (r3) => {
        a3.value = r3, e4.onHtmlChanged(r3);
      },
...
var Rl = defineComponent({
  ...
  setup(e4) {
    ...
    return () => {
      ...
      }, [`${(a3 = o2.value.footer) == null ? void 0 : a3.markdownTotal}:`]), createVNode("span", null, [((l2 = e4.modelValue) == null ? void 0 : l2.length) || 0])]);
    };
  }
});
var Pl = {
...
var Ul = defineComponent({
  ...
  setup(e4) {
    ...
    return () => {
      ...
      }, [(a3 = o2.value.footer) == null ? void 0 : a3.scrollAuto]), createVNode(Nl, {
...
var Kl = defineComponent({
  ...
  setup(e4) {
    const o2 = computed(() => {
      const l2 = e4.footers.indexOf("="), i2 = l2 === -1 ? e4.footers : e4.footers.slice(0, l2), r3 = l2 === -1 ? [] : e4.footers.slice(l2, Number.MAX_SAFE_INTEGER);
      return [i2, r3];
    }), a3 = (l2) => {
      if (m.includes(l2))
        switch (l2) {
          case "markdownTotal":
            return createVNode(Rl, {
              modelValue: e4.modelValue
            }, null);
          case "scrollSwitch":
        ...
        return e4.defFooters instanceof Array ? e4.defFooters[l2] || "" : e4.defFooters && e4.defFooters.children instanceof Array && e4.defFooters.children[l2] || "";
    };
    return () => {
      const l2 = o2.value[0].map((r3) => a3(r3)), i2 = o2.value[1].map((r3) => a3(r3));
      return createVNode("div", {
        class: `${a}-footer`
      }, [createVNode("div", {
        class: `${a}-footer-left`
...
var jl = defineComponent({
  ...
  setup(e4, o2) {
    ...
    ut(e4, o2), mt(e4), ft(e4);
    const [u3, d2] = ht(e4, o2), v = pt(e4);
    return onBeforeUnmount(() => {
      ...
      return createVNode("div", {
        id: a3,
        class: [a, e4.class, e4.theme === "dark" && `${a}-dark`, u3.fullscreen || u3.pageFullscreen ? `${a}-fullscreen` : ""],
        style: e4.style
      }, [createVNode(Yt, {
        noPrettier: r3,
        ...
        noHighlight: m4,
        onChange: (g4) => {
          e4.onChange ? e4.onChange(g4) : (o2.emit("update:modelValue", g4), o2.emit("onChange", g4));
        },
        onHtmlChanged: (g4) => {
          e4.onHtmlChanged ? e4.onHtmlChanged(g4) : o2.emit("onHtmlChanged", g4);
        },
        onGetCatalog: (g4) => {
          e4.onGetCatalog ? e4.onGetCatalog(g4) : o2.emit("onGetCatalog", g4);
        },
        onBlur: (g4) => {
          e4.onBlur ? e4.onBlur(g4) : o2.emit("onBlur", g4);
        },
        onFocus: (g4) => {
          e4.onFocus ? e4.onFocus(g4) : o2.emit("onFocus", g4);
        },
        completions: e4.completions,
        catalogVisible: v.value,
        theme: e4.theme
      }, null), ((p3 = e4.footers) == null ? void 0 : p3.length) > 0 && createVNode(Kl, {
        modelValue: e4.modelValue,
        footers: e4.footers,
        defFooters: b4,
        scrollAuto: f3.scrollAuto,
        onScrollAutoChange: (g4) => f3.scrollAuto = g4
      }, null)]);
    };
  }
});
var ue = jl;
ue.install = (e4) => (e4.component(ue.name, ue), e4.use(e3).use(f).use(g3).use(I2).use(R2), e4);
